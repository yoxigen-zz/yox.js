...
f[a]-n[a]-e;if(o[a]>b)m[a]=n[a]+b;else{var c=h[a],b=f[a]-n[a]+q[c]+e,c=o[a]+i[c];c<b&&(m[a]=n[a]+b-c)}}var d=b;b===document.body&&!$.browser.webkit&&(d=document.documentElement);var i={width:b.clientWidth,height:b.clientHeight},k=d.scrollHeight,l=d.scrollWidth,e=e||0;if(i.height>=k&&i.width>=l)return!1;if(!c)return a.scrollIntoView(),!0;var a=$(a),f=a.offset(),q={width:a.width(),height:a.height()},n={left:d.scrollLeft,top:d.scrollTop},o=$(b).offset(),m={},h={top:"height",left:"width"};g("top");g("left");
...
yox.data.sources.flickr=function(a){function b(a,f){return"http://farm"+a.farm+".static.flickr.com/"+a.server+"/"+(a.primary||a.id)+"_"+a.secret+f+".jpg"}function c(f,c){var d=f.photoset||f.photos,e,q=[],k=f.photoset?"/in/set-"+f.photoset.id:"";d?e=f.photoset?f.photoset.photo:f.photos.photo:f.photosets?e=f.photosets.photoset:f.collections&&(e=f.collections.collection[0].set);if(e){var i=n[c.thumbsize],l=n[c.imageSize];a.each(e,function(a,f){var e={thumbnail:{src:b(f,i)},link:(g+"photos/"+(f.owner||
c.user_id)+"/"+f.id+k).replace(/\s/g,"_"),url:b(f,l),title:d?f.title:f.title._content,type:"image",description:f.description?f.description._content:void 0};d||(e.data={photoset_id:f.id});q.push(e)})}return q}var e="flickr",g="http://www.flickr.com/",d="http://api.flickr.com/services/rest/",i=/\d+@N\d+/,k=/^http:\/\/(?:www\.)?flickr\.com\/(\w+)\/(?:([^\/]+)\/(?:(\w+)\/?(?:([^\/]+)\/?)?)?)?(?:\?(.*))?/,l={api_key:"9a220a98ef188519fb87b08d310ebdbe",format:"json"},f={imageSize:"medium",thumbsize:"thumbnail",
...
{smallSquare:"_s",thumbnail:"_t",small:"_m",medium:"",large:"_b",original:"_o"};return{name:e,defaults:f,map:{pageSize:"per_page"},match:function(a){return a.url&&k.test(a.url)},load:function(o,m){function h(){a.ajax({url:d,dataType:"jsonp",data:u,jsonpCallback:"jsonFlickrApi",success:function(f){var d={source:o,sourceType:e,createThumbnails:!0};d.items=c(f,u);(f.photosets||f.collections)&&a.extend(d,{createGroups:!0});if(0<d.items.length&&(u.setThumbnail&&!u.setSinglePhotosetThumbnails||o.isSingleLink))a.extend(d,
...
load:function(d,f,e){var k=b(d.url);if(!k)return e&&e({message:"Invalid Twitpic URL, can't parse fields."}),!1;a.ajax(c(k,d),{dataType:"jsonp",success:function(a){for(var b=jQuery.extend({},i,k,d),c=[],e={name:a.name,avatar:a.avatar_url,link:a.website},q=0,s;s=a.images[q];q++)c.push({thumbnail:{src:["http://twitpic.com/show/",b.thumbsize,"/",s.short_id,"?key=",g].join("")},link:"http://twitpic.com/"+s.short_id,url:["http://twitpic.com/show/",b.imageSize,"/",s.short_id,"?key=",g].join(""),title:s.message,
...
if(e){var h=0,n=function(a){c&&c.call(this,a);if((a instanceof Date||"IMG"===a.target.nodeName)&&++h===e)f.removeEventListener("load",n,!0),b&&b(e)},i=function(a){c&&c.call(this,a);++h===e&&b&&b(e);a.srcElement.detachEvent("onload",i)};if(f.addEventListener)f.addEventListener("load",n,!0);else if(f.attachEvent)for(var k=e;k--;)d[k].attachEvent("onload",i);for(k=e;k--;)d[k].complete&&n(g)}else b&&b(0)}function d(){return/(Android)|(iPhone)|(iPod)/.test(navigator.userAgent)||4E5>screen.width*screen.height}
...
t=b?parseInt(c.css("left"),10):t;var b=t+f*s,d=0<b?(f-b)/f:b<this.minPosition?(f-this.minPosition+b)/f:1;0!==d&&(b=t+d*f*s,a*=d,f=E.getCubicBezier(d),c.css({transition:"left "+a+"s cubic-bezier("+f+")",left:b}))}function q(a){v.elements.$window.off(b,D);currentDirection=0;a.data.view.elements.$window.off(c,q);if(a.data.view.enableDrag&&0!==y){var d=Math.min(Math.abs(y)/(7*z),0.86),e=d*u,d=Math.round(1E3*d*d*u);f.call(a.data.view,e,d);r=!1;v=null}return!1}function n(f){var g=this;f.on(e,function(e){var h=
d?window.event.touches[0]:e;e.preventDefault();w=h.pageX;x=h.timeStamp||new Date;k.call(g,e);g.enableDrag&&f.css({transition:"none",left:f.css("left")});y=0;r=!1;v=g;a(window).on(b,{$slider:f,minPosition:g.minPosition,view:g},D).on(c,{view:g},q)}).on(c,function(a){a.preventDefault();var f=w,f=f>h-4&&f<h+4;(g.enableDrag&&!r||f)&&g.triggerEvent("click",a)})}var o={centerContentsIfNotScrollable:!0,events:{buttonholdstart:function(a){i.call(this,a,"holdstart")},buttonholdend:function(){this.stopScroll()},
buttonclick:function(a){i.call(this,a,"click")}},"float":"left",isHorizontal:!0,scrollByTime:0.5,scrollToEasing:"ease-in-out",scrollToElementTime:0.2,scrollVelocity:500,toggleButtons:!0},m=a(window),h,p,r=!1,s=0,t,v,w,y=0,x,z,u=2.5,d=d();b=d?"touchmove":"mousemove";e=d?"touchstart":"mousedown";c=d?"touchend":"mouseup";var A,C,B={buttonDown:function(f){f.preventDefault();var b=this,e=f.data.view.options.pressedButtonClass;e&&a(b).addClass(e);A=setTimeout(function(){m.on(c,f.data,B.holdEnd);if(!d)m.on("mouseout",
...
c.$slider[0].style.setProperty("-webkit-transform","translateZ(0)",null);f=c.$container;"static"===f.css("position")&&f.css("position","relative");f.children().appendTo(c.$slider);c.$slider.appendTo(c.$container);this.initEvents();this.update();this.initButtons();n.call(this,c.$slider);c.$slider.on("click",function(a){a.preventDefault()})},initButtons:function(){if(!this.options.elements)return!1;if(this.options.elements instanceof jQuery)this.options.elements.on(e,{view:this},B.buttonDown).on(c,
...
yox.view.cache=function(){function a(a,b){var f=!0;d++;b&&++a.cacheCount===a.items.length&&(delete a.cacheCount,a.isLoaded=!0,f=!1);f&&(f=d+q<a.options.cacheBuffer);f&&c(a)}function b(b){if(!this.width||!this.height)return!1;var b=k[l=b.data.cacheImageIndex],d=b.item,c=b.view;d.width=this.width;d.height=this.height;d.ratio=this.height/this.width;d.isLoaded=!0;d.id===o&&(c.triggerEvent("cacheEnd",d),o=null);c.triggerEvent("loadItem",d);b.onCache&&(b.onCache.call(c,d),b.onCache=null);q--;delete b.item;
...
e.type?(m=k[l],m.item=e,m.view=b,$.browser.mozilla&&(m.img.src=""),h&&(m.onCache=h),m.img.src=e.url,q++,++l===k.length&&(l=0),q<i&&d+q<b.options.cacheBuffer&&c(b)):(a(b,!e.isLoaded),e.isLoaded=!0,h&&h.call(b,e));return!0}for(var g,d=0,i=2,k=[],l=0,f=(new Date).valueOf(),q=0,n,o,m=0;m<i;m++){var h=new Image;h.setAttribute("data-id",m);$(h).on("load",{cacheImageIndex:m},b).on("error",function(){console.error("Image not found or couldn't load:",this.src)});k.push({img:h})}return{cacheItem:e,withItem:function(b,
c,h){if(3>arguments.length||arguments[2]!==f)d=0;b.isLoaded?(h.call(c,b),o&&(c.triggerEvent("cacheEnd",b),o=null),g=b.id-1,c.isLoaded||a(c,!1)):(n&&clearTimeout(n),n=setTimeout(function(){b.isLoaded||(n=null,c.triggerEvent("cacheStart",b),o=b.id)},200),e(c,b,h,f))}}}();yox.view.transition=function(a){this.name=a};yox.view.transitions={};
...
c);b.push(e.appendTo(d))}};this.destroy=function(){i.$container.css("perspective","");for(var a=0;a<b.length;a++)b[a].remove()};this.getCurrentPanel=function(){return b[c]};this.getPanel=function(){c=c?0:1;return b[c]};this.transition=function(a){clearTimeout(l);var g=i.getCurrentPanel(),n=b[c?0:1].show(),o=a.index<d&&!(d===this.items.length-1&&0===a.index)||a.index===this.items.length-1&&!d;g.css($.extend(a.position,{display:"block",transform:o?"translateZ(500px)":"translateZ(-800px)",transition:"none",
zIndex:o?3:1}));setTimeout(function(){n.css({transform:o?"translateZ(-800px)":"translateZ(500px)",opacity:0,zIndex:o?1:3});g.css({transition:k,transform:"translateZ(0)",zIndex:2,opacity:1});d=a.index;o||(l=setTimeout(function(){n.hide()},e))},10)};this.update=function(d){if(void 0!==d.transitionTime){a(d.transitionTime);for(d=b.length;d--;)b[d].css("transitionDuration",g)}}};yox.view.transitions.evaporate.prototype=new yox.view.transition("evaporate");
...
yox.themes.classic=function(a,b){function c(){}function e(a){var b=$(a);b.toggleClass("yox-theme-classic-button-on");m.triggerEvent("toggle",{action:a.innerHTML,state:b.hasClass("yox-theme-classic-button-on")})}function g(){s&&(r=!r);r?(m.modules.view.option("resizeMode","fit"),h.gallery.style.cursor="none",h.gallery.style.height=document.documentElement.clientHeight-(x?b.thumbnailsHeight:0)+"px"):(h.gallery.style.height=v+"px",h.gallery.style.cursor="default");var a=$(window),d=r?a.on:a.off;d.call(a,
"mousemove",l);s||d.call($(document),"keydown",k);t=!1;i();e(z.fullscreen)}function d(){t=!0;s?r?document.cancelFullScreen():(h.themeContents.style.height="100%",h.themeContents.requestFullScreen()):(r=!r,h.themeContents.style.position=r?"fixed":"relative",h.themeContents.style.height=r?"100%":v,h.themeContents.style.border=r?"none":"solid 1px Black",h.themeContents.style.zIndex=r?"100":"1",g(),m.modules.scroll.updateSize())}function i(){if(t)return!1;f();m.modules.view.update(!0)}function k(a){27===
a.keyCode&&d()}function l(a){if(!w||a.pageX<w.x-3||a.pageX>w.x+3||a.pageY<w.y-3||a.pageY>w.y+3)clearTimeout(p),h.controlsPanel.style.opacity="1",h.gallery.style.cursor="default",p=setTimeout(function(){var b=h.controlsPanel.getClientRects()[0];a.pageY>=b.top&&a.pageY<=b.bottom&&a.pageX>=b.left&&a.pageX<=b.right||(h.controlsPanel.style.opacity="0",h.gallery.style.cursor="none")},1E3);w={x:a.pageX,y:a.pageY}}function f(){var a=r?document.documentElement.clientHeight:h.container.clientHeight;x&&(a-=
b.thumbnailsHeight);h.gallery.style.height=a+"px"}function q(){i();m.triggerEvent("resize")}function n(a){var b=document.createElement("a");b.innerHTML=a.title;b.className=m.getThemeClass("button")+" "+m.getThemeClass("button-"+a.action);b.setAttribute("data-action",a.action);return b}function o(a){var b=document.createElement("a"),d=m.getThemeClass("controlBtn");b.setAttribute("data-method",a);b.className=d+" "+d+"-"+a;b.innerHTML="<div></div>";return b}var m=this,h,p,r,s,t,v,w,y=b.showInfo,x=b.showThumbnails,
z={},u=a.countItems(),A={fullscreen:d,info:function(a){y=!y;h.infoPanel.style.opacity=y?"1":"0";e(a)},slideshow:function(){m.modules.view.toggleSlideshow()},thumbnails:function(a){x=!x;h.gallery.style.height=h.gallery.clientHeight+b.thumbnailsHeight*(x?-1:1)+"px";m.modules.view.update();e(a)}};this.name="classic";this.config={view:{enableKeyboard:!0,enlarge:!0,resizeMode:"fit",transition:yox.view.transitions.fade,transitionTime:300,margin:0,events:{cacheStart:function(){h.loader.style.display="inline"},
...
action:"thumbnails"}],c=0,g;g=d[c];c++)h.controlsPanel.appendChild(z[g.action]=n(g));$(h.controlsPanel).on("click","a",function(a){a.preventDefault();A[this.getAttribute("data-action")](this)});h.gallery.appendChild(h.controlsPanel);b.showInfo?e(z.info):h.infoPanel.style.opacity="0";b.showThumbnails&&e(z.thumbnails);d=document.createElement("div");d.className=this.getThemeClass("info-position");d.appendChild(h.infoPosition);d.appendChild(document.createTextNode(" / "));h.infoItemsCount.innerHTML=
u;h.infoPosition.innerHTML="0";d.appendChild(h.infoItemsCount);h.info.appendChild(d);h.infoText.className=this.getThemeClass("info-text");h.info.appendChild(h.infoText);b.showCopyright&&(h.copyright=document.createElement("a"),h.copyright.target="_blank",h.copyright.className=this.getThemeClass("copyright"),h.info.appendChild(h.copyright));h.infoPanel.appendChild(h.info);h.gallery.appendChild(h.infoPanel);h.infoPanel.className=this.getThemeClass("infoPanel");h.info.className=this.getThemeClass("info");
...
thumbnails:{events:{beforeSelect:function(a){this.select(a.newItem.id-1)},loadItem:function(a){$(this.thumbnails[a.id-1]).addClass("loaded")},"create.thumbnails":function(){this.select(0)}}}};document.cancelFullScreen=document.cancelFullScreen||document.mozCancelFullScreen||document.webkitCancelFullScreen||c;HTMLElement.prototype.requestFullScreen=HTMLElement.prototype.requestFullScreen||HTMLElement.prototype.mozRequestFullScreen||HTMLElement.prototype.webkitRequestFullScreen||c;(o=document.cancelFullScreen!==
...
p[e],l.style.width=parseInt(l.style.width,10)+1+"px";if(!c||d)a.style.marginRight="0",p=[],r=0}else e&&a.style.removeProperty("margin-right")}function k(b){b.length&&(b=b[0],t||(t=b.source,v=b.totalItems,t.type=b.sourceType),a.countItems()>=v&&n.triggerEvent("loadedAllItems"));o=!1;$(n.container).removeClass(h)}function l(){this.style.visibility="visible";this.style.setProperty(yox.utils.browser.getCssPrefix()+"transform","scale(1)");this.removeEventListener("load",l,!1)}function f(){!o&&c.scrollTop>=
c.scrollHeight-c.clientHeight-b.thumbnailsMaxHeight&&(o=!0,$(n.container).addClass(h),t&&(t.offset=a.countItems()+1,a.addSources([t])))}c=void 0;e=void 0;g=void 0;d=void 0;var q,n=this,o,m=!1;this.name="wall";var h=this.getThemeClass("loading"),p=[],r=0;this.config={thumbnails:{createThumbnail:function(a,c,d){var e=document.createElement("a"),f=document.createElement("img"),g={height:b.thumbnailsMaxHeight,width:Math.round(b.thumbnailsMaxHeight/c.ratio)};e.dimensions=g;f.addEventListener("load",l,
...
document.getElementsByTagName("head")[0].appendChild(t);$(window).on("resize",function(){clearTimeout(s);s=setTimeout(function(){q=l.clientWidth-2*b.padding;p=[];r=0;var a=n.modules.thumbnails.thumbnails;if(a)for(var c=a.length,d=0,e;e=a[d];d++)i(e,d,c,!0)},50)});e=l===document.body?document:l;c=l;!$.browser.webkit&&l===document.body&&(c=document.documentElement);d=document.createElement("div");d.className=this.getThemeClass("loader");d.style.paddingBottom=b.borderWidth+b.padding+"px";l.appendChild(d);
