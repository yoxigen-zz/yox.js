...
yox.data.prototype.addDataSource(function(){var a;a=window.URL&&window.URL.createObjectURL?function(a){return window.URL.createObjectURL(a)}:window.webkitURL&&window.webkitURL.createObjectURL?function(a){return window.webkitURL.createObjectURL(a)}:function(){return null};return{name:"files",match:function(){return!1},load:function(b,c){for(var e=[],d=0,f;f=b.files[d];d++)if(/^image\//.test(f.type)){var h=a(f);e.push({url:h,type:"image",title:f.name||f.fileName,thumbnail:{src:h}})}e={items:e,source:b,
sourceType:"files",createThumbnails:!0};c&&c(e)}}}());
...
1&&(e=a[d])&&a[d-1]>=c;);return e}function c(a){var b=h;a.user&&"lh"!=a.user?(b+="user/"+a.user,a.album&&(b+="/album/"+a.album)):b+="all";return b}function e(a){var b=[];jQuery.each(a.feed.entry,function(a,c){var d="album"===c.category[0].term.match(/#(.*)$/)[1];if(d&&!c.gphoto$numphotos.$t)return!0;var e=c.media$group.media$content[0],k={thumbnail:{src:c.media$group.media$thumbnail[0].url},url:e.url,link:c.link[0].href,title:d?c.title.$t:c.summary.$t,type:"image"};d?(k.data={album:{name:c.title.$t,
imageCount:c.gphoto$numphotos.$t,description:c.summary.$t}},k.isLoaded=!0):$.extend(k,{width:e.width,height:e.height,ratio:e.height/e.width});b.push(k)});return b}var d=/^https?:\/\/picasaweb\.google\./,f=/https?:\/\/picasaweb\.google\.\w+\/([^\/#\?]+)\/?([^\/#\?]+)?(\?([^#]*))?/,h="http://picasaweb.google.com/data/feed/api/",l=[32,48,64,72,104,144,150,160],m=[94,110,128,200,220,288,320,400,512,576,640,720,800,912,1024,1152,1280,1440,1600].concat(l).sort(function(a,b){return a-b}),g={setThumbnail:!0,
...
if(f){var i=0,g=function(a){d&&d.call(this,a);if((a instanceof Date||"IMG"===a.target.nodeName)&&++i===f)b.removeEventListener("load",g,!0),c&&c(f)},n=function(a){d&&d.call(this,a);++i===f&&c&&c(f);a.srcElement.detachEvent("onload",n)};if(b.addEventListener)b.addEventListener("load",g,!0);else if(b.attachEvent)for(var h=f;h--;)e[h].attachEvent("onload",n);for(h=f;h--;)e[h].complete&&g(k)}else c&&c(0)}function f(){return/(Android)|(iPhone)|(iPod)/.test(navigator.userAgent)||4E5>screen.width*screen.height}
function h(b,c){var d=a(b).data("yoxscroll-"+c);if(d){var d=d.split("-"),e=this[d.shift()];e&&e.apply(this,d)}}function l(){p=u;q=parseInt(this.elements.$slider.css("left"),10)}function m(a,b,c){var d=(a.timeStamp||new Date)-z;if(!d)return!1;C=d;z=a.timeStamp||new Date;r=a.pageX-u;u=a.pageX;this.enableDrag&&(a=q+u-p,d=Math.abs(r)/r,a>=c&&0>=a?b.css("left",a):((!r||d!==v)&&l.call(y),a<c&&s!==c?b.css("left",a=c):0<a&&0!==s&&b.css("left",a=0)),x=!0,v=d,s=a)}function g(a,b,c){var d=this.elements.$slider;
s=c?parseInt(d.css("left"),10):s;var c=s+b*v,e=0<c?(b-c)/b:c<this.minPosition?(b-this.minPosition+c)/b:1;0!==e&&(c=s+e*b*v,a*=e,b=E.getCubicBezier(e),d.css({transition:"left "+a+"s cubic-bezier("+b+")",left:c}))}function k(a){y.elements.$window.off(b,D);currentDirection=0;a.data.view.elements.$window.off(c,k);if(a.data.view.enableDrag&&0!==r){var d=Math.min(Math.abs(r)/(7*C),0.86),e=d*A,d=Math.round(1E3*d*d*A);g.call(a.data.view,e,d);x=!1;y=null}return!1}function i(d){var i=this;d.on(e,function(e){var g=
f?window.event.touches[0]:e;e.preventDefault();u=g.pageX;z=g.timeStamp||new Date;l.call(i,e);i.enableDrag&&d.css({transition:"none",left:d.css("left")});r=0;x=!1;y=i;a(window).on(b,{$slider:d,minPosition:i.minPosition,view:i},D).on(c,{view:i},k)}).on(c,function(a){a.preventDefault();var b=u,b=b>p-4&&b<p+4;(i.enableDrag&&!x||b)&&i.triggerEvent("click",a)})}var n={centerContentsIfNotScrollable:!0,events:{buttonholdstart:function(a){h.call(this,a,"holdstart")},buttonholdend:function(){this.stopScroll()},
buttonclick:function(a){h.call(this,a,"click")}},"float":"left",isHorizontal:!0,scrollByTime:0.5,scrollToEasing:"ease-in-out",scrollToElementTime:0.2,scrollVelocity:500,toggleButtons:!0},o=a(window),p,q,x=!1,v=0,s,y,u,r=0,z,C,A=2.5,f=f();b=f?"touchmove":"mousemove";e=f?"touchstart":"mousedown";c=f?"touchend":"mouseup";var w,B,t={buttonDown:function(b){b.preventDefault();var d=this,e=b.data.view.options.pressedButtonClass;e&&a(d).addClass(e);w=setTimeout(function(){o.on(c,b.data,t.holdEnd);if(!f)o.on("mouseout",
...
getIndex:function(){return e.itemCount++}}),d.appendTo(this.container),this.thumbnails=d;else{d=document.createDocumentFragment();for(var f=0,h=b.items.length;f<h;f++,this.itemCount++){var l=b.items[f],m=this.createThumbnail(l);m.setAttribute("data-yoxthumbindex",this.itemCount);l.thumbnail.element=m;l.thumbnail.generated=!0;var g=m.getElementsByTagName("img");g.length&&(l.thumbnail.image=g[0]);d.appendChild(m)}this.container.appendChild(d);this.thumbnails=this.thumbnails.add(a(this.container).children("."+
...
this.items.length?0:this.currentItem.id,void 0,a)},option:function(b,c){var d;void 0===c&&Object(b)===b?d=b:(d={},d[b]=c);for(var e in d){var f=this.options[e],g=d[e];if(f!==g){var h=m[e];h&&h.call(this,g,f)}}this.transition.update&&this.transition.update.call(this,d);a.extend(!0,this.options,d)},toggleSlideshow:function(){var a=this;this.isPlaying?(clearTimeout(this.playTimeoutId),this.isPlaying=!1,this.triggerEvent("slideshowStop")):(this.isPlaying=!0,this.playTimeoutId=setTimeout(function(){a.next.call(a,
...
(o.img.src=""),i&&(o.onCache=i),o.img.src=e.url,k++,++m===l.length&&(m=0),k<h&&f+k<b.options.cacheBuffer&&c(b)):(a(b,!e.isLoaded),e.isLoaded=!0,i&&i.call(b,e));return!0}for(var d,f=0,h=2,l=[],m=0,g=(new Date).valueOf(),k=0,i,n,o=0;o<h;o++){var p=new Image;p.setAttribute("data-id",o);$(p).on("load",{cacheImageIndex:o},b).on("error",function(){console.error("Image not found or couldn't load:",this.src)});l.push({img:p})}return{cacheItem:e,withItem:function(b,c,h){if(3>arguments.length||arguments[2]!==
...
g.gallery.appendChild(g.viewer);g.gallery.appendChild(g.thumbnails);g.gallery.appendChild(g.loader);g.viewer.className=this.getThemeClass("viewer")+" yoxview";g.title.className=this.getThemeClass("title");g.gallery.className=this.getThemeClass("gallery");g.thumbnails.className=this.getThemeClass("thumbnails")+" yoxthumbnails";g.loader.className=this.getThemeClass("loader")+" yoxloader";g.description=this.getThemeClass("description");b.title&&(g.title.innerHTML=b.title);o=g.gallery.clientHeight;p=
