...
f[a]-o[a]-e;if(n[a]>b)m[a]=o[a]+b;else{var c=h[a],b=f[a]-o[a]+r[c]+e,c=n[a]+i[c];c<b&&(m[a]=o[a]+b-c)}}var d=b;b===document.body&&!$.browser.webkit&&(d=document.documentElement);var i={width:b.clientWidth,height:b.clientHeight},k=d.scrollHeight,l=d.scrollWidth,e=e||0;if(i.height>=k&&i.width>=l)return!1;if(!c)return a.scrollIntoView(),!0;var a=$(a),f=a.offset(),r={width:a.width(),height:a.height()},o={left:d.scrollLeft,top:d.scrollTop},n=$(b).offset(),m={},h={top:"height",left:"width"};g("top");g("left");
if(void 0!==m.top||void 0!==m.left)b={},m.top&&(b.scrollTop=m.top),m.left&&(b.scrollLeft=m.left),$(d).stop(!0,!0).animate(b,c)}},dimensions:{distributeMeasures:function(a){var b={top:0,bottom:0,left:0,right:0};if(a){var c="number"===typeof a,e;for(e in b)b[e]=c?a:a[e]||0}b.horizontal=b.left+b.right;b.vertical=b.top+b.bottom;return b},resize:{fill:function(a,b,c){c=c||{};a.ratio=a.ratio||a.height/a.width;var e=c.enlarge?b.width:Math.min(a.width,b.width),g=Math.round(e*a.ratio),d=b.height;if(g<d&&(d<=
a.height||c.enlarge))g=d,e=Math.round(g/a.ratio);return{left:Math.round((b.width-e)/2),top:Math.round((b.height-g)/2),width:Math.round(e),height:Math.round(g)}},fit:function(a,b,c){c=c||{};a.ratio=a.ratio||a.height/a.width;var e=c.margin||{},g=c.padding||{},d=b.width-(e.horizontal||0)-(g.horizontal||0),c=c.enlarge?d:Math.min(a.width,d),d=Math.round(c*a.ratio),i=b.height-(e.vertical||0)-(g.vertical||0);d>i&&(d=i,c=Math.round(d/a.ratio));return{left:(b.width-(e.left||0)-(e.right||0)-c)/2+(e.left||0)-
(g.left||0),top:(b.height-(e.top||0)-(e.bottom||0)-d)/2+(e.top||0)-(g.top||0),width:c,height:d}}}},performance:{debounce:function(a,b,c){var e=this,g=Array.prototype.slice.call(arguments,2);clearTimeout(a.bounceTimer);a.bounceTimer=setTimeout(function(){a.apply(e,g)},b)},throttle:function(a,b){a.bounceTimer=null;return function(){var c=this,e=arguments;clearTimeout(a.bounceTimer);a.bounceTimer=setTimeout(function(){a.apply(c,e)},b)}}},url:{queryToJson:function(a){if(!a)return null;for(var a=a.split("&"),
b={},c=a.length;c--;){var e=a[c].split("=");b[e[0]]=2==e.length?e[1]:!0}return b}}};Function.prototype.bind||(Function.prototype.bind=function(a){if("function"!==typeof this)throw new TypeError("Function.prototype.bind - what is trying to be bound is not callable");var b=Array.prototype.slice.call(arguments,1),c=this,e=function(){},g=function(){return c.apply(this instanceof e?this:a||window,b.concat(Array.prototype.slice.call(arguments)))};e.prototype=this.prototype;g.prototype=new e;return g});
yox.eventsHandler=function(){var a={_default:{}},b,c,e=this;this.triggerEvent=function(g,d,i){b=g;var k=g.split("."),g=k[0];if(k=k[1])if(k=a[k]){var l=k[g];if(l)for(var k=0,f;f=l[k];k++)f.call(this,d,i)}if(g=a._default[g])for(k=0;f=g[k];k++)f.call(this,d,i);b=void 0;if(c){for(k=0;d=c[k];k++)e.removeEventListener(d.eventName,d.eventHandler);c=void 0}};this.addEventListener=function(b,c){var e=b.split("."),k=e[0],l=e[1];l?(e=a[l])||(e=a[l]={}):e=a._default;(l=e[k])||(l=e[k]=[]);l.push(c)};this.removeEventListener=
function(e,d){if(e===b)return c=c||[],c.push({eventName:e,eventHandler:d}),!1;var i=e.split("."),k=i[0],l=i[1],f,i=!1;l?(f=a[l])||(f=a[l]={}):f=a._default;if((k=f[k])&&k.length)for(l=k.length;l--;)k[l]===d&&(k.splice(l,1),i=!0);return i}};yox.eventsHandler.prototype={bindTriggerEvent:function(a,b){var c=this;return function(e,g){return c.triggerEvent.call(a,e,g,b)}}};
...
yox.data.sources.flickr=function(a){function b(a,f){return"http://farm"+a.farm+".static.flickr.com/"+a.server+"/"+(a.primary||a.id)+"_"+a.secret+f+".jpg"}function c(f,c){var d=f.photoset||f.photos,e,r=[],k=f.photoset?"/in/set-"+f.photoset.id:"";d?e=f.photoset?f.photoset.photo:f.photos.photo:f.photosets?e=f.photosets.photoset:f.collections&&(e=f.collections.collection[0].set);if(e){var l=o[c.thumbsize],i=o[c.imageSize];a.each(e,function(a,f){var e={thumbnail:{src:b(f,l)},link:(g+"photos/"+(f.owner||
c.user_id)+"/"+f.id+k).replace(/\s/g,"_"),url:b(f,i),title:d?f.title:f.title._content,type:"image",description:f.description?f.description._content:void 0};d||(e.data={photoset_id:f.id});r.push(e)})}return r}var e="flickr",g="http://www.flickr.com/",d="http://api.flickr.com/services/rest/",i=/\d+@N\d+/,k=/^http:\/\/(?:www\.)?flickr\.com\/(\w+)\/(?:([^\/]+)\/(?:(\w+)\/?(?:([^\/]+)\/?)?)?)?(?:\?(.*))?/,l={api_key:"9a220a98ef188519fb87b08d310ebdbe",format:"json"},f={imageSize:"medium",thumbsize:"thumbnail",
setThumbnail:!0,setSinglePhotosetThumbnails:!0,setTitle:!0,method:"flickr.photosets.getList",extras:"description"},r={sets:function(a,f){return{method:f||a.photoset_id?"flickr.photosets.getPhotos":"flickr.photosets.getList",photoset_id:f}},galleries:function(a,f){return{method:f?"flickr.galleries.getPhotos":"flickr.galleries.getList",gallery_id:f}},collections:function(a,f){return{method:"flickr.collections.getTree",collection_id:f}},"default":function(){return{method:"flickr.photos.search"}}},o=
{smallSquare:"_s",thumbnail:"_t",small:"_m",medium:"",large:"_b",original:"_o"};return{name:e,defaults:f,map:{pageSize:"per_page"},match:function(a){return a.url&&k.test(a.url)},load:function(n,m){function h(){a.ajax({url:d,dataType:"jsonp",data:v,jsonpCallback:"jsonFlickrApi",success:function(f){var d={source:n,sourceType:e,createThumbnails:!0};d.items=c(f,v);(f.photosets||f.collections)&&a.extend(d,{createGroups:!0});if(0<d.items.length&&(v.setThumbnail&&!v.setSinglePhotosetThumbnails||n.isSingleLink))a.extend(d,
{isGroup:!0,link:(g+"photos/"+f.photoset.owner+"/sets/"+f.photoset.id+"/").replace(/\s/g,"_"),thumbnailSrc:n.isSingleLink?void 0:b(f.photoset.photo[0],o[v.thumbsize]),title:"None"});m&&m(d)},error:function(){if(options.onLoadError)options.onLoadError("Flickr plugin encountered an error while retrieving data")}})}var s=!0,p=n.url&&n.url.match(k),q,u={},y={method:"flickr.urls.lookupUser",onData:function(a){return{user_id:a.user.id,username:a.user.username._content}}};if(n.url&&!p)return!1;if(p){var t=
p[1],w=p[2],z=p[3],x=p[4];if(p=p[5])q=yox.utils.url.queryToJson(p),a.extend(u,q);if("search"==t){u.method="flickr.photos.search";u.text=q.q;q.w&&(q.w=q.w.replace("%40","@"),q.w.match(i)&&(u.user_id=q.w));if(!q||!q.sort)u.sort="relevance";s=!1}else z?(a.extend(u,r[z||"default"](n,x)),"galleries"===z&&x&&(s=!0,y={method:"flickr.urls.lookupGallery",onData:function(a){return{gallery_id:a.gallery.id,title:a.gallery.title}}})):u.method="flickr.people.getPublicPhotos",u.username=w,u.type=z}var v=jQuery.extend({},
f,u,n,l);v.media="photos";v.user&&v.photoset_id&&(v.method="flickr.photosets.getPhotos");q=screen.width>screen.height?screen.width:screen.height;if(!v.imageSize||800>=q.width&&"medium"!=v.imageSize)v.imageSize="medium";s?a.ajax({url:d,dataType:"jsonp",data:a.extend({url:n.url,method:y.method},l),jsonpCallback:"jsonFlickrApi",success:function(f){a.extend(v,y.onData(f));h()}}):h()}}}(jQuery);
...
Math.max(screen.width,screen.height)),c=a.length,d;c-- -1&&(d=a[c])&&a[c-1]>=b;);return d}function c(a){var f=i;a.user&&"lh"!=a.user?(f+="user/"+a.user,a.album&&(f+="/album/"+a.album)):f+="all";return f}function e(a){var f=[];jQuery.each(a.feed.entry,function(a,b){var c="album"===b.category[0].term.match(/#(.*)$/)[1];if(c&&!b.gphoto$numphotos.$t)return!0;var d=b.media$group.media$content[0],e={thumbnail:{src:b.media$group.media$thumbnail[0].url},url:d.url,link:b.link[0].href,title:c?b.title.$t:b.summary.$t,
type:"image",author:{name:b.media$group.media$credit[0].$t},width:parseInt(b.gphoto$width,10),height:parseInt(b.gphoto$height,10)};e.ratio=e.height/e.width;c?(e.data={album:{name:b.gphoto$name.$t,imageCount:b.gphoto$numphotos.$t,description:b.summary.$t}},e.isLoaded=!0):$.extend(e,{width:d.width,height:d.height,ratio:d.height/d.width});f.push(e)});return f}var g=/^https?:\/\/picasaweb\.google\./,d=/^https?:\/\/picasaweb\.google\.\w+\/([^\/#\?]+)\/?([^\/#\?]+)?(?:\?([^#]*))?/,i="http://picasaweb.google.com/data/feed/api/",
...
load:function(d,f,e){var k=b(d.url);if(!k)return e&&e({message:"Invalid Twitpic URL, can't parse fields."}),!1;a.ajax(c(k,d),{dataType:"jsonp",success:function(a){for(var b=jQuery.extend({},i,k,d),c=[],e={name:a.name,avatar:a.avatar_url,link:a.website},r=0,q;q=a.images[r];r++)c.push({thumbnail:{src:["http://twitpic.com/show/",b.thumbsize,"/",q.short_id,"?key=",g].join("")},link:"http://twitpic.com/"+q.short_id,url:["http://twitpic.com/show/",b.imageSize,"/",q.short_id,"?key=",g].join(""),title:q.message,
...
d=g}d||f.push(e(b,c))});return f}var d=/^http:\/\/(?:www\.)?youtube.com\//,i={singleVideo:/^http:\/\/(?:www\.)?youtube.com\/watch\?v=([^\&]+)(.*)?/,playlist:/^http:\/\/(?:www\.)?youtube.com\/(?:view_play_list|my_playlists)\?p=([^\&]+)(.*)?/,user:/^http:\/\/(?:www\.)?youtube.com\/user\/([^\?]+)(?:\?(.*))?/,search:/^http:\/\/(?:www\.)?youtube.com\/results\?(.*)/};apiUrl="http://gdata.youtube.com/feeds/api/videos";fixedOptions={v:2,format:5,alt:"jsonc"};defaults={hqThumbnails:!1,aspectRatio:"auto"};
c.id=1;return{name:"youtube",match:function(a){return a.url&&d.test(a.url)},load:function(c,d){if(!d)throw Error("Can't load YouTube data, no callback provided.");var f=a.extend({},defaults,c,fixedOptions);if(c.url){var e,o;for(o in i)if(e=c.url.match(i[o])){f.feedType=o;break}if(e){switch(f.feedType){case "singleVideo":f.isSingleVideo=!0;f.url+="/"+e[1];break;case "playlist":f.url="http://gdata.youtube.com/feeds/api/playlists/"+e[1];break;case "user":f.url="http://gdata.youtube.com/feeds/api/users/"+
...
(function(a){a.fn.yoxscroll=function(b){if(0!=this.length){var c=a(this),e=c.data("yoxscroll");if("string"===typeof b&&e&&e[b])return e[b].apply(e,Array.prototype.slice.call(arguments,1));"object"===typeof b||!b?c.data("yoxscroll",new yox.scroll(this,b)):a.error("Method "+b+" does not exist on yox.scroll.")}return this};yox.scroll=function(a,c){this.container=a;this.init(c)};yox.scroll.prototype=function(){var b,c,e;function g(f,b,c){a(f);var d=f.getElementsByTagName("img"),e=d.length,g=new Date;
if(e){var h=0,i=function(a){c&&c.call(this,a);if((a instanceof Date||"IMG"===a.target.nodeName)&&++h===e)f.removeEventListener("load",i,!0),b&&b(e)},r=function(a){c&&c.call(this,a);++h===e&&b&&b(e);a.srcElement.detachEvent("onload",r)};if(f.addEventListener)f.addEventListener("load",i,!0);else if(f.attachEvent)for(var k=e;k--;)d[k].attachEvent("onload",r);for(k=e;k--;)d[k].complete&&i(g)}else b&&b(0)}function d(){return/(Android)|(iPhone)|(iPod)/.test(navigator.userAgent)||4E5>screen.width*screen.height}
function i(f,b){var c=a(f).data("yoxscroll-"+b);if(c){var c=c.split("-"),d=this[c.shift()];d&&d.apply(this,c)}}function k(){h=t;s=parseInt(this.elements.$slider.css("left"),10)}function l(a,f,b){var c=(a.timeStamp||new Date)-z;if(!c)return!1;x=c;z=a.timeStamp||new Date;w=a.pageX-t;t=a.pageX;this.enableDrag&&(a=s+t-h,c=Math.abs(w)/w,a>=b&&0>=a?f.css("left",a):((!w||c!==q)&&k.call(y),a<b&&u!==b?f.css("left",a=b):0<a&&0!==u&&f.css("left",a=0)),p=!0,q=c,u=a)}function f(a,f,b){var c=this.elements.$slider;
u=b?parseInt(c.css("left"),10):u;var b=u+f*q,d=0<b?(f-b)/f:b<this.minPosition?(f-this.minPosition+b)/f:1;0!==d&&(b=u+d*f*q,a*=d,f=E.getCubicBezier(d),c.css({transition:"left "+a+"s cubic-bezier("+f+")",left:b}))}function r(a){y.elements.$window.off(b,D);currentDirection=0;a.data.view.elements.$window.off(c,r);if(a.data.view.enableDrag&&0!==w){var d=Math.min(Math.abs(w)/(7*x),0.86),e=d*v,d=Math.round(1E3*d*d*v);f.call(a.data.view,e,d);p=!1;y=null}return!1}function o(f){var g=this;f.on(e,function(e){var h=
d?window.event.touches[0]:e;e.preventDefault();t=h.pageX;z=h.timeStamp||new Date;k.call(g,e);g.enableDrag&&f.css({transition:"none",left:f.css("left")});w=0;p=!1;y=g;a(window).on(b,{$slider:f,minPosition:g.minPosition,view:g},D).on(c,{view:g},r)}).on(c,function(a){a.preventDefault();var f=t,f=f>h-4&&f<h+4;(g.enableDrag&&!p||f)&&g.triggerEvent("click",a)})}var n={centerContentsIfNotScrollable:!0,events:{buttonholdstart:function(a){i.call(this,a,"holdstart")},buttonholdend:function(){this.stopScroll()},
buttonclick:function(a){i.call(this,a,"click")}},"float":"left",isHorizontal:!0,scrollByTime:0.5,scrollToEasing:"ease-in-out",scrollToElementTime:0.2,scrollVelocity:500,toggleButtons:!0},m=a(window),h,s,p=!1,q=0,u,y,t,w=0,z,x,v=2.5,d=d();b=d?"touchmove":"mousemove";e=d?"touchstart":"mousedown";c=d?"touchend":"mouseup";var A,C,B={buttonDown:function(f){f.preventDefault();var b=this,e=f.data.view.options.pressedButtonClass;e&&a(b).addClass(e);A=setTimeout(function(){m.on(c,f.data,B.holdEnd);if(!d)m.on("mouseout",
f.data,B.mouseOut);f.data.view.triggerEvent("buttonholdstart",b);A=null;C=b},200)},buttonUp:function(f){var b=f.data.view.options.pressedButtonClass;b&&a(this).removeClass(b);A&&(clearTimeout(A),f.data.view.triggerEvent("buttonclick",this),A=null)},holdEnd:function(a){m.off(c,B.holdEnd);d||m.off("mouseout",B.mouseOut);a.data.view.triggerEvent("buttonholdend",C);C=null;return!1},mouseOut:function(a){a.relatedTarget||B.holdEnd(a)}},E=function(){function a(f,b){this.x=f;this.y=b}var f=[0,0.42,0.36,1],
b=[new a(0,0),new a(f[0],f[1]),new a(f[2],f[3]),new a(1,1)],c=f.join(", ");return{getCubicBezier:function(f){if(f)return c;for(var d=[b,[],[],[]],e=[b[0]],g=1;3>=g;g++)for(j=0;j<=3-g;j++){var h=new a(Math.abs(f-1)*d[g-1][j].x+f*d[g-1][j+1].x,Math.abs(f-1)*d[g-1][j].y+f*d[g-1][j+1].y);d[g][j]=h;j||e.push(h)}f=e[3];for(g=1;4>g;g++)h=e[g],h.x/=f.x,h.y/=f.y;return[e[1].x,e[1].y,e[2].x,e[2].y].join(", ")}}}(),D=d?function(a){l.call(a.data.view,window.event.touches[0],a.data.$slider,a.data.minPosition)}:
...
{},n,b);b.toggleButtons&&(b.events.changeStatus=function(a){this.options.elements.toggle(a.scrollEnabled)});for(var c in f){var d=b.events[c],e=f[c];d?d instanceof Array||(d=b.events[c]=[d]):d=b.events[c]=[];e instanceof Array?d=d.concat(e):"function"===typeof e&&d.push(e)}this.options=b;c=this.elements={$window:a(window),$container:a(this.container),$slider:a("<div>",{"class":"yoxscrollSlider",css:a.extend({position:"relative",top:0,left:0},b.isHorizontal?{height:"100%"}:{width:"100%"})})};a.browser.webkit&&
c.$slider[0].style.setProperty("-webkit-transform","translateZ(0)",null);f=c.$container;"static"===f.css("position")&&f.css("position","relative");f.children().appendTo(c.$slider);c.$slider.appendTo(c.$container);this.initEvents();this.update();this.initButtons();o.call(this,c.$slider);c.$slider.on("click",function(a){a.preventDefault()})},initButtons:function(){if(!this.options.elements)return!1;if(this.options.elements instanceof jQuery)this.options.elements.on(e,{view:this},B.buttonDown).on(c,
...
this.getAttribute("data-yoxthumbIndex"),d;b.preventDefault();d=this.classList&&g.options.selectedThumbnailClass?this.classList.contains(g.options.selectedThumbnailClass):a(this).hasClass(g.options.selectedThumbnailClass);g.triggerEvent("click",{originalEvent:b,index:f,target:this,isSelected:d});d||g.select(f)};a(this.container).on("click","[data-yoxthumbindex]",k);this.addEventListener("beforeDestroy",function(){a(this.container).off("click","."+g.options.thumbnailClass,k)})}};yox.thumbnails.prototype=
...
g.appendTo(this.container),this.thumbnails=g;else{g=document.createDocumentFragment();for(var d=0,i=b.items.length;d<i;d++,this.itemCount++){var k=b.items[d],l=e.options.createThumbnail?e.options.createThumbnail.call(e,d,k,i):this.createThumbnail(k);l.setAttribute("data-yoxthumbindex",this.itemCount);k.thumbnail.element=l;k.thumbnail.generated=!0;var f=l.getElementsByTagName("img");f.length&&(k.thumbnail.image=f[0]);g.appendChild(l)}this.thumbnails=this.thumbnails.add(g.childNodes);this.container.appendChild(g)}g=
...
(function(a){yox.utils.css.addJqueryCssHooks("transition,transitionDuration,transform,transformOrigin,transformStyle,backfaceVisibility,perspective".split(","));yox.view=function(b,c,e){var g=a.extend({},c.events),d=yox.view.config,i=yox.view.config.platform[yox.utils.browser.getPlatform()],e=e||yox.view.cache;delete c.events;var c=a.extend(!0,{},d.mode[c.resizeMode||i.resizeMode||d.defaults.resizeMode],d.defaults,i,c),k;for(k in g)d=c.events[k],i=g[k],d?d instanceof Array||(d=c.events[k]=[d]):d=
c.events[k]=[],i instanceof Array?d.concat(i):"function"===typeof i&&d.push(i);this.container=b;this.$container=a(b);this.options=c;this.id=yox.view.id?++yox.view.id:1;this.cache=e;this.direction=1;for(var l in this)b=this[l],"function"===typeof b&&(this[l]=b.bind(this));this.init()};yox.view.prototype=function(){var b,c;function e(a){var b="string"===typeof a?yox.view.transitions[a]:a;if(!b)throw Error('Invalid transition - "'+a+"\" doesn't exist.");a=new b;if(!(a instanceof yox.view.transition))throw Error("Invalid transition - transition constructors must have yox.view.transition as prototype.");
a.create.call(this,this.$container);this.transition=a}function g(f,b){var d=f.data(b);if(!d&&((d=l[b].create.call(this))?f.append(d):d=f[0],f.data(b,d),d!==f[0]&&(d.style.height=d.style.width="100%",d.style.display="none"),this.options.displayInfo)){var c=a("<div>",{"class":"yoxview_info"});f.append(c).data("info",c)}return d}function d(a){for(var b=[],d=this.items.length,c=0;c<a.length;c++){var e=a[c];this.items=this.items.concat(e.items);b=b.concat(e.items)}c=d;for(d=this.items.length;c<d;c++)this.items[c].id=
c+1;this.triggerEvent("load",{items:b,sources:a});this.initialized||(this.initialized=!0,this.triggerEvent("init"))}function i(a,b){if(a!==this.currentItem)return!1;if(a){var d=l[a.type],c=d.checkLoading?this.transition.getCurrentPanel():this.transition.getPanel(),e=c.data("itemType"),h=g.call(this,c,a.type);e!==a.type&&(e&&(e&&d.clear.call(this,h),c.data(e).style.display="none"),c.data("itemType",a.type));if(d.checkLoading&&!h.loading&&(!this.options.showThumbnailsBeforeLoad||b))c=this.transition.getPanel(a),
h=g.call(this,c,a.type);this.options.displayInfo&&(c=c.data("info"),a.title?c.text(a.title).removeAttr("disabled"):c.text("").attr("disabled","disabled"));h.style.display="block";d.set.call(this,a,h,b)}else this.transition.getPanel(a),this.transition.transition.call(this,{item:a}),this.triggerEvent("select",a)}b={40:"down",35:"end",13:"enter",36:"home",37:"left",39:"right",32:"space",38:"up",72:"h",27:"escape"};c=function(a){var d=a.data.view,c=d[d.options.keyPress[b[a.keyCode]]];return c?(a.preventDefault(),
c.call(d),!1):!0};var k={resizeMode:function(a){this.getPosition=yox.utils.dimensions.resize[a]},transition:function(a){this.transition.destroy.call(this);e.call(this,a);a=this.currentItem.id-1;this.currentItem=null;this.selectItem(a)}},l={html:{clear:function(a){a.innerHTML=""},create:function(){var a=document.createElement("div");a.style.overflow="hidden";return a},set:function(a,b){b.loading=!1;a.element?(b.innerHTML="",b.appendChild(a.element)):b.innerHTML=a.html;a.width||(a.width=this.containerDimensions.width);
...
d=a.getPosition(f,a.containerDimensions,a.options);a.transition.transition.call(a,{position:d,index:f.id-1,item:f})}}return{checkLoading:!0,clear:function(a){a.src=""},create:function(){var d=document.createElement("img");d.src="";a(d).on("load",{view:this},b);return d},set:function(a,d,c){a=c&&a.thumbnail?a.thumbnail.src:a.url;d.loading=!0;c&&(d.loadingThumbnail=!0);d.src!==a?(d.src="",d.src=a):b.call(d,this)}}}()};return{addDataSources:function(a){function b(a){d.call(c,a)}var c=this,e=a.getData();
e&&e.length&&d.call(c,e);a.addEventListener("loadSources",b);this.addEventListener("beforeDestroy",function(){a.removeEventListener("loadSources",b)});a.addEventListener("clear",function(){c.removeItems()})},cacheCount:0,close:function(){this.currentItem&&(this.selectItem(null),this.triggerEvent("close"))},destroy:function(){this.triggerEvent("beforeDestroy");this.disableKeyboard();this.transition.destroy()},disableKeyboard:function(){a(document).off("keydown.modules",c)},enableKeyboard:function(){a(document).on("keydown.modules",
{view:this},c)},first:function(){if(!this.currentItem)return!1;this.selectItem(0)},items:[],init:function(){var b=this;this.options.margin=yox.utils.dimensions.distributeMeasures(this.options.margin);this.options.padding=yox.utils.dimensions.distributeMeasures(this.options.padding);var d=this.options.eventsHandler||new yox.eventsHandler;a.extend(this,d);for(var c in this.options.events)if(d=this.options.events[c],d instanceof Array)for(var g=0;g<d.length;g++)b.addEventListener(c,d[g]);else b.addEventListener(c,
d);"static"===this.$container.css("position")&&this.$container.css("position","relative");a.extend(this,{getPosition:yox.utils.dimensions.resize[this.options.resizeMode],elements:{}});e.call(this,this.options.transition);this.options.data&&this.addDataSources(this.options.data);this.options.enableKeyboard&&this.enableKeyboard();if(this.options.controls)for(var i in this.options.controls)if(this[i])a(this.options.controls[i]).data("yoxviewControl",i).on("click",function(d){d.preventDefault();b[a(this).data("yoxviewControl")].call(b)});
this.update();this.triggerEvent("create")},last:function(){if(!this.currentItem)return!1;this.selectItem(this.items.length-1)},next:function(a){if(!this.currentItem)return!1;this.direction=1;this.selectItem(this.currentItem.id===this.items.length?0:this.currentItem.id,void 0,a)},option:function(b,d){var c;void 0===d&&Object(b)===b?c=b:(c={},c[b]=d);for(var e in c){var g=this.options[e],h=c[e];if(g!==h){var i=k[e];i&&i.call(this,h,g)}}this.transition.update&&this.transition.update.call(this,c);a.extend(!0,
this.options,c)},toggleSlideshow:function(){var a=this;this.isPlaying?(clearTimeout(this.playTimeoutId),this.isPlaying=!1,this.triggerEvent("slideshowStop")):(this.isPlaying=!0,this.playTimeoutId=setTimeout(function(){a.next.call(a,!0)},this.options.slideshowDelay),this.triggerEvent("slideshowStart"))},prev:function(){if(!this.currentItem)return!1;this.direction=-1;this.selectItem(1===this.currentItem.id?this.items.length-1:this.currentItem.id-2)},removeItems:function(){this.triggerEvent("removeItems",
this.items);this.currentItem=void 0;this.items=[]},removeEventListener:function(b,d){if(d&&"function"!==typeof d)throw Error("Invalid event handler, must be a function or undefined.");a(this.container).off(b+".modules",d)},selectItem:function(b,d,c){!c&&this.isPlaying?this.toggleSlideshow():c&&!this.isPlaying&&(this.isPlaying=!0,this.triggerEvent("slideshowStart"));if(!isNaN(b)){if(b>=this.items.length||0>b)throw Error("Invalid item index: "+b);b=this.items[b]}if(""+b===b){for(var c=0,e;e=this.items[c];c++)if(e.name&&
e.name===b){b=e;break}e=null}else b instanceof HTMLElement&&(b=a(b)),b instanceof jQuery&&(c=b.data("yoxviewIndex"),isNaN(c)&&(c=parseInt(b.attr("data-yoxviewIndex"),10)),b=this.items[c]);var c=this.currentItem,g=this;if(c&&b&&b.id===c.id)return!1;this.triggerEvent("beforeSelect",{newItem:b,oldItem:c,data:d});(this.currentItem=b)?(g.options.showThumbnailsBeforeLoad&&i.call(g,b,!0),this.cache.withItem(b,this,function(a){i.call(g,a)})):i.call(g,b);return!0},unload:function(){},update:function(a){this.options.transitionTime&&
...
yox.view.cache=function(){function a(a,b){var f=!0;d++;b&&++a.cacheCount===a.items.length&&(delete a.cacheCount,a.isLoaded=!0,f=!1);f&&(f=d+r<a.options.cacheBuffer);f&&c(a)}function b(b){if(!this.width||!this.height)return!1;var b=k[l=b.data.cacheImageIndex],d=b.item,c=b.view;d.width=this.width;d.height=this.height;d.ratio=this.height/this.width;d.isLoaded=!0;d.id===n&&(c.triggerEvent("cacheEnd",d),n=null);c.triggerEvent("loadItem",d);b.onCache&&(b.onCache.call(c,d),b.onCache=null);r--;delete b.item;
a(c,!0)}function c(a){var b=a.items.length,d=g+a.direction;d===b?d=0:-1===d&&(d+=b);e(a,a.items[d],null,f)}function e(b,e,h){if(!(b instanceof yox.view))throw new TypeError("Invalid view for cacheItem.");if(!b)throw Error("View is required for cacheItem.");if(4>arguments.length||arguments[3]!==f)d=0;e=e||b.items[0];if("image"!==e.type)return h&&h.call(b,e),!0;for(var n=0;n<i;n++){var m=k[n];if(m.view&&m.view.id===b.id&&m.item&&m.item.id===e.id&&h)return m.onCache=h,!0}g=e.id-1;!e.isLoaded&&"image"===
e.type?(m=k[l],m.item=e,m.view=b,$.browser.mozilla&&(m.img.src=""),h&&(m.onCache=h),m.img.src=e.url,r++,++l===k.length&&(l=0),r<i&&d+r<b.options.cacheBuffer&&c(b)):(a(b,!e.isLoaded),e.isLoaded=!0,h&&h.call(b,e));return!0}for(var g,d=0,i=2,k=[],l=0,f=(new Date).valueOf(),r=0,o,n,m=0;m<i;m++){var h=new Image;h.setAttribute("data-id",m);$(h).on("load",{cacheImageIndex:m},b).on("error",function(){console.error("Image not found or couldn't load:",this.src)});k.push({img:h})}return{cacheItem:e,withItem:function(b,
c,h){if(3>arguments.length||arguments[2]!==f)d=0;b.isLoaded?(h.call(c,b),n&&(c.triggerEvent("cacheEnd",b),n=null),g=b.id-1,c.isLoaded||a(c,!1)):(o&&clearTimeout(o),o=setTimeout(function(){b.isLoaded||(o=null,c.triggerEvent("cacheStart",b),n=b.id)},200),e(c,b,h,f))}}}();yox.view.transition=function(a){this.name=a};yox.view.transitions={};
...
yox.view.transitions.evaporate=function(){function a(a){e=a;g=a+"ms";k=yox.utils.browser.getCssPrefix()+"transform "+g+" ease-out, opacity "+g+" ease-out"}var b,c=1,e,g,d=0,i=this,k,l;this.create=function(d){i.$container=d;d.css("perspective","800px");a(this.options.transitionTime);b=[];for(var c=0;2>c;c++){var e=$("<div>",{"class":"yoxviewImg"});e.css({position:"absolute",top:"50%",left:"50%",width:0,height:0,border:"solid 1px #666",transform:c?"translateZ(-500px)":"translateZ(0)"});e.attr("data-index",
c);b.push(e.appendTo(d))}};this.destroy=function(){i.$container.css("perspective","");for(var a=0;a<b.length;a++)b[a].remove()};this.getCurrentPanel=function(){return b[c]};this.getPanel=function(){c=c?0:1;return b[c]};this.transition=function(a){clearTimeout(l);var g=i.getCurrentPanel(),o=b[c?0:1].show(),n=a.index<d&&!(d===this.items.length-1&&0===a.index)||a.index===this.items.length-1&&!d;g.css($.extend(a.position,{display:"block",transform:n?"translateZ(500px)":"translateZ(-800px)",transition:"none",
zIndex:n?3:1}));setTimeout(function(){o.css({transform:n?"translateZ(-800px)":"translateZ(500px)",opacity:0,zIndex:n?1:3});g.css({transition:k,transform:"translateZ(0)",zIndex:2,opacity:1});d=a.index;n||(l=setTimeout(function(){o.hide()},e))},10)};this.update=function(d){if(void 0!==d.transitionTime){a(d.transitionTime);for(d=b.length;d--;)b[d].css("transitionDuration",g)}}};yox.view.transitions.evaporate.prototype=new yox.view.transition("evaporate");
...
yox.view.transitions.thumbnails=function(){function a(a){return function(){a.css("visibility","visible")}}function b(b){clearTimeout(r);clearTimeout(o);var f=c[e],h=c[e?0:1];if(b.isUpdate)f.css(b.position);else{if(b.item){var s=$(b.item.thumbnail.image),p=s.offset(),q=s.width()/b.position.width;p.top-=k.scrollTop;p.left-=k.scrollLeft;f.show().css($.extend({transition:"none",transform:["scale(",q,") translateX(",Math.round((p.left-b.position.left-b.position.width*(1-q)/2)/q),"px) translateY(",Math.round((p.top-
b.position.top-b.position.height*(1-q)/2)/q),"px) translateZ(0)"].join(""),"z-index":i+1},b.position));r=setTimeout(function(){f.css({transform:"scale(1) translateX(0) translateY(0) translateZ(0)",transition:"all "+g+"ms ease-out"})},5)}h&&d&&(p=d.offset(),q=d.width()/l.width,p.top-=k.scrollTop,p.left-=k.scrollLeft,h.css({"z-index":i,transform:["scale(",q,") translateX(",Math.round((p.left-l.left-l.width*(1-q)/2)/q),"px) translateY(",Math.round((p.top-l.top-l.height*(1-q)/2)/q),"px) translateZ(0)"].join("")}),
o=setTimeout(function(){h.hide()},g),setTimeout(a(d),g));l=b.position;(d=s)&&d.css("visibility","hidden")}}var c,e=1,g,d,i=100,k,l;this.create=function(a){function b(){var c=$("<div>",{"class":"yoxviewFrame yoxviewFrame_"+d.options.resizeMode+" yoxviewFrame_"+yox.utils.browser.getPlatform()+" yoxviewFrame_thumbnails",css:{transition:"all "+g+"ms linear",transformOrigin:"center center",display:"none","box-sizing":"border-box",position:"fixed",overflow:"visible"}}).appendTo(a);$.browser.webkit&&c[0].style.setProperty("-webkit-transform",
"translateZ(0)");var e=document.createElement("a");e.className="yoxview_close";e.onclick=d.close;c.append(e);a.append(c);return c}var d=this;g=this.options.transitionTime;c=[];for(var e=0;2>e;e++)c.push(b(e));for(k=a[0];!~["scroll","auto"].indexOf(window.getComputedStyle(k,null).overflow)&&k.parentNode&&k!==document.documentElement;)k=k.parentNode};this.destroy=function(){for(var a=0;a<c.length;a++)c[a].remove();c=[]};this.getCurrentPanel=function(){return c[e]};this.getPanel=function(){e=e?0:1;return c[e]};
var f=yox.utils.performance.throttle(b,120),r,o;this.transition=function(a){a.isUpdate?f.call(this,a):b.call(this,a)};this.update=function(){}};yox.view.transitions.thumbnails.prototype=new yox.view.transition("thumbnails");yox.theme=function(){};yox.themes={};
yox.theme.prototype={create:function(){throw Error("'create' method is not implemented for this theme.");},destroy:function(){throw Error("'destroy' method is not implemented for this theme.");},getThemeClass:function(a){return"yox-theme-"+this.name+(a?"-"+a:"")},init:function(a,b,c,e){function g(a,d,e){e.data=b;e.eventsHandler={addEventListener:function(a,b){c.addEventListener(a,b.bind(this))},triggerEvent:function(a,b,e){c.triggerEvent.call(this,a+"."+d,b,e||this)}};return new l(a,e)}if(!(b instanceof
yox.data))throw Error("Invalid data provided for theme, must be an instance of yox.data.");$.extend(this,c);this.create(a);var d=$.extend(!0,{},this.config,e.modules),i;for(i in d){var k=d[i],l=yox[i];if(!l)throw Error("Module not found: '"+i+"', can't create theme '"+this.name+"'.");var f=$(".yox"+i,a);if(k instanceof Array){this.modules[i]=[];for(var r=0;e=k[r];r++)this.modules[i].push(g(f[r],i,e))}else this.modules[i]=g(f[0],i,k)}},config:{},modules:{}};
yox.themes.classic=function(a,b){function c(){}function e(a){var b=$(a);b.toggleClass("yox-theme-classic-button-on");m.triggerEvent("toggle",{action:a.innerHTML,state:b.hasClass("yox-theme-classic-button-on")})}function g(){q&&(p=!p);p?(m.modules.view.option("resizeMode","fit"),h.gallery.style.cursor="none",h.gallery.style.height=document.documentElement.clientHeight-(z?b.thumbnailsHeight:0)+"px"):(h.gallery.style.height=y+"px",h.gallery.style.cursor="default");var a=$(window),d=p?a.on:a.off;d.call(a,
"mousemove",l);q||d.call($(document),"keydown",k);u=!1;i();e(x.fullscreen)}function d(){u=!0;q?p?document.cancelFullScreen():(h.themeContents.style.height="100%",h.themeContents.requestFullScreen()):(p=!p,h.themeContents.style.position=p?"fixed":"relative",h.themeContents.style.height=p?"100%":y,h.themeContents.style.border=p?"none":"solid 1px Black",h.themeContents.style.zIndex=p?"100":"1",g(),m.modules.scroll.updateSize())}function i(){if(u)return!1;f();m.modules.view.update(!0)}function k(a){27===
a.keyCode&&d()}function l(a){if(!t||a.pageX<t.x-3||a.pageX>t.x+3||a.pageY<t.y-3||a.pageY>t.y+3)clearTimeout(s),h.controlsPanel.style.opacity="1",h.gallery.style.cursor="default",s=setTimeout(function(){var b=h.controlsPanel.getClientRects()[0];a.pageY>=b.top&&a.pageY<=b.bottom&&a.pageX>=b.left&&a.pageX<=b.right||(h.controlsPanel.style.opacity="0",h.gallery.style.cursor="none")},1E3);t={x:a.pageX,y:a.pageY}}function f(){var a=p?document.documentElement.clientHeight:h.container.clientHeight;z&&(a-=
b.thumbnailsHeight);h.gallery.style.height=a+"px"}function r(){i();m.triggerEvent("resize")}function o(a){var b=document.createElement("a");b.innerHTML=a.title;b.className=m.getThemeClass("button")+" "+m.getThemeClass("button-"+a.action);b.setAttribute("data-action",a.action);return b}function n(a){var b=document.createElement("a"),d=m.getThemeClass("controlBtn");b.setAttribute("data-method",a);b.className=d+" "+d+"-"+a;b.innerHTML="<div></div>";return b}var m=this,h,s,p,q,u,y,t,w=b.showInfo,z=b.showThumbnails,
x={},v=a.countItems(),A={fullscreen:d,info:function(a){w=!w;h.infoPanel.style.opacity=w?"1":"0";e(a)},slideshow:function(){m.modules.view.toggleSlideshow()},thumbnails:function(a){z=!z;h.gallery.style.height=h.gallery.clientHeight+b.thumbnailsHeight*(z?-1:1)+"px";m.modules.view.update();e(a)}};this.name="classic";this.config={view:{enableKeyboard:!0,enlarge:!0,resizeMode:"fit",transition:yox.view.transitions.fade,transitionTime:300,margin:0,events:{cacheStart:function(){h.loader.style.display="inline"},
cacheEnd:function(){h.loader.style.display="none"},"click.thumbnails":function(a){this.selectItem(a.index,"scroll")},"init.view":function(){this.selectItem(this.options.firstItem||0);h.infoPanel.style.opacity="1"},slideshowStart:function(){e(x.slideshow)},slideshowStop:function(){e(x.slideshow)},beforeSelect:function(a){h.infoText.innerHTML=a.newItem.title||"";h.infoPosition.innerHTML=a.newItem.id;b.showCopyright&&(a.newItem.author?(h.copyright.href=a.newItem.author.link||a.newItem.link,h.copyright.innerHTML=
...
function(){$(h.container).addClass(m.getThemeClass("loading"))});!1!==b.enableFullScreen&&(document.cancelFullScreen=document.cancelFullScreen||document.mozCancelFullScreen||document.webkitCancelFullScreen||c,HTMLElement.prototype.requestFullScreen=HTMLElement.prototype.requestFullScreen||HTMLElement.prototype.mozRequestFullScreen||HTMLElement.prototype.webkitRequestFullScreen||c,q=document.cancelFullScreen!==c);!1!==b.enableFullScreen&&q&&document.addEventListener(document.mozCancelFullScreen?"mozfullscreenchange":
...
action:"thumbnails"}],c=0,g;g=d[c];c++)h.controlsPanel.appendChild(x[g.action]=o(g));$(h.controlsPanel).on("click","a",function(a){a.preventDefault();A[this.getAttribute("data-action")](this)});h.gallery.appendChild(h.controlsPanel);b.showInfo?e(x.info):h.infoPanel.style.opacity="0";b.showThumbnails&&e(x.thumbnails);d=document.createElement("div");d.className=this.getThemeClass("info-position");d.appendChild(h.infoPosition);d.appendChild(document.createTextNode(" / "));h.infoItemsCount.innerHTML=
...
h.gallery.appendChild(n("prev"));h.gallery.appendChild(n("next"));y=h.gallery.clientHeight;f();$(h.gallery).on("mousemove",l).on("click","."+this.getThemeClass("controlBtn"),function(){m.modules.view[this.getAttribute("data-method")]()});$(window).on("resize",r)};this.destroy=function(){$(h.container).removeClass(this.getThemeClass());h.container.removeChild(h.themeContents);h=null;clearTimeout(s);$(window).off("resize",r)}};
...
yox.themes.inline=function(a,b){function c(){}function e(){n&&(o=!o);o?(r=setTimeout(function(){f.$thumbnails.css({opacity:0});document.body.style.cursor="none"},3E3),l.modules.view.option("resizeMode","fit")):(clearTimeout(r),f.$thumbnails.css("opacity","1"),f.gallery.style.height=m+"px",document.body.style.cursor="default",l.modules.view.option("resizeMode","fill"));d();var a=$(window),b=o?a.on:a.off;b.call(a,"mousemove",k);n||b.call($(document),"keydown",i)}function g(){n?o?document.cancelFullScreen():
(f.gallery.style.height="100%",f.gallery.requestFullScreen()):(o=!o,f.gallery.style.position=o?"fixed":"relative",f.gallery.style.height=o?"100%":m,f.gallery.style.border=o?"none":"solid 1px Black",f.gallery.style.zIndex=o?"100":"1",e())}function d(){l.modules.view.update(!0);h=f.thumbnails.getClientRects()[0]}function i(a){27===a.keyCode&&g()}function k(a){if(!s||a.pageX<s.x-4||a.pageX>s.x+4||a.pageY<s.y-4||a.pageY>s.y+4)clearTimeout(r),f.$thumbnails.css("opacity","1"),document.body.style.cursor=
"default",r=setTimeout(function(){a.pageY>=h.top||(f.$thumbnails.css({opacity:0}),document.body.style.cursor="none")},2E3);s={x:a.pageX,y:a.pageY}}var l=this,f,r,o,n,m,h,s;this.name="inline";this.config={view:{enableKeyboard:!0,enlarge:!0,resizeMode:"fill",transition:"fade",transitionTime:300,events:{cacheStart:function(){f.loader.style.display="inline"},cacheEnd:function(){f.loader.style.display="none"},"click.thumbnails":function(a){this.selectItem(a.index)},"init.view":function(){this.selectItem(0)}}},
...
yox.themes.switcher=function(a){function b(){e.modules.view.update()}var c,e=this,g=!1;this.name="switcher";this.config={view:{displayInfo:!0,enableKeyboard:!0,enlarge:!1,resizeMode:"fit",transition:yox.view.transitions.thumbnails,transitionTime:400,margin:{top:45,right:30,left:30,bottom:30},showThumbnailsBeforeLoad:!0,events:{"click.thumbnails":function(a,b){g&&a.isSelected?(this.close(),b.unselect()):this.selectItem(a.index)},beforeSelect:function(a){!g&&a.newItem&&(g=!0,$(c.container).addClass(e.getThemeClass("open")))},
close:function(){e.modules.view.close();g=!1;$(c.container).removeClass(e.getThemeClass("open"))}}}};a.addEventListener("clear",function(){e.modules.view.close()});this.create=function(a){c={background:document.createElement("div"),view:document.createElement("div"),container:a};c.background.className=this.getThemeClass("background");c.view.className=this.getThemeClass("view")+" yoxview";a.appendChild(c.background);a.appendChild(c.view);$(window).on("resize",b);$(c.view).on("click","img",function(){e.modules.view.next()})};
this.destroy=function(){c.container.removeChild(c.background);c.container.removeChild(c.view);$(window).off("resize",b);$(c.container).removeClass(e.getThemeClass("open"));c=null}};yox.themes.switcher.defaults={scrollDuration:500};yox.themes.switcher.prototype=new yox.theme;
yox.themes.wall=function(a,b){var c,e,g,d;function i(a,c,d,e){w+=a.dimensions.width;t.push(a);var c=c===d-1,f=(t.length-1)*b.borderWidth;if((d=w+f>=o)||c){var e=(o-f)/w,g=Math.round(t[0].dimensions.height*e),i=!0,k=d||h;g>b.thumbnailsMaxHeight&&(g=b.thumbnailsMaxHeight,i=!1);for(var l=0,m;m=t[l];l++){var n=Math.floor(m.dimensions.width*e),f=f+n;m.style.height=g+"px";i?m.style.width=n+"px":c&&(m.style.width=m.dimensions.width+"px");k&&m.style.removeProperty("display")}for(e=t.length;e--&&f<o;f++)m=
t[e],m.style.width=parseInt(m.style.width,10)+1+"px";if(!c||d)a.style.marginRight="0",t=[],w=0}else e&&a.style.removeProperty("margin-right")}function k(){var a=n.modules.thumbnails.thumbnails;if(a)for(var b=a.length,c=0,d;d=a[c];c++)i(d,c,b,!0)}function l(b){b.length&&(b=b[0],x||(x=b.source,v=b.totalItems,x.type=b.sourceType),a.countItems()>=v&&n.triggerEvent("loadedAllItems"));m=!1;$(n.container).removeClass(y)}function f(){p<u?(p++,this.style.visibility="visible",this.style.setProperty(yox.utils.browser.getCssPrefix()+
"transform","scale(1)"),this.removeEventListener("load",f,!1),setTimeout(function(){p--;s.length&&f.call(s.shift())},q)):s.push(this)}function r(){!m&&c.scrollTop>=c.scrollHeight-c.clientHeight-b.thumbnailsMaxHeight&&(m=!0,$(n.container).addClass(y),x&&(x.offset=a.countItems()+1,a.addSources([x])))}c=void 0;e=void 0;g=void 0;d=void 0;var o,n=this,m,h=!1,s=[],p=0,q=100,u=3;this.name="wall";var y=this.getThemeClass("loading"),t=[],w=0,z=yox.utils.performance.throttle(function(a){yox.utils.dom.scrollIntoView(a,
n.container,b.scrollAnimationDuration,b.scrollOffset)},300);this.config={thumbnails:{createThumbnail:function(a,c,d){var e=document.createElement("a"),g=document.createElement("img"),h={height:b.thumbnailsMaxHeight,width:Math.round(b.thumbnailsMaxHeight/c.ratio)};e.dimensions=h;g.addEventListener("load",f,!1);g.src=c.thumbnail.src;e.appendChild(g);e.setAttribute("href",c.url);e.style.display="none";i(e,a,d);return e},events:{beforeSelect:function(a){b.scrollToElementOnSelect&&a.newItem&&z(a.newItem.thumbnail.element)},
create:r}}};var x,v;l(a.getData());a.addEventListener("loadSources",l);a.addEventListener("clear",function(){x=null;t=[];w=0;h&&(h=!1,e.addEventListener("scroll",r,!1),a.addEventListener("loadSources",l),$(n.container).removeClass(n.getThemeClass("loadedAll")))});this.create=function(f){this.container=f;var i=this.getThemeClass();$(f).addClass(i).addClass(y);g=document.createElement("div");g.className=this.getThemeClass("thumbnails")+" yoxthumbnails";g.style.padding=b.padding+"px";f.appendChild(g);
o=f.clientWidth-2*b.padding;var m=document.createElement("style");m.innerHTML=" ."+i+" a[data-yoxthumbindex]{ "+["margin-right: "+b.borderWidth+"px","margin-bottom: "+b.borderWidth+"px"].join("; ")+" }";document.getElementsByTagName("head")[0].appendChild(m);$(window).on("resize",yox.utils.performance.throttle(function(){$(f).addClass(n.getThemeClass("resizing"));o=f.clientWidth-2*b.padding;t=[];w=0;k();setTimeout(function(){$(n.container).removeClass(n.getThemeClass("resizing"))},5)},50));e=f===
document.body?document:f;c=f;!$.browser.webkit&&f===document.body&&(c=document.documentElement);d=document.createElement("div");d.className=this.getThemeClass("loader");d.style.paddingBottom=b.borderWidth+b.padding+"px";f.appendChild(d);e.addEventListener("scroll",r,!1);n.addEventListener("loadedAllItems",function(){e.removeEventListener("scroll",r,!1);a.removeEventListener("loadSources",l);h=!0;$(f).addClass(n.getThemeClass("loadedAll"))})}};
