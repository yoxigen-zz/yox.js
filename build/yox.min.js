...
e.user_id)+"/"+b.id+m).replace(/\s/g,"_"),url:c(b,n),title:g?b.title:b.title._content,type:"image",description:b.description?b.description._content:void 0};g||(i.data={photoset_id:b.id});k.push(i)})}return k}var d="flickr",f="http://www.flickr.com/",e="http://api.flickr.com/services/rest/",h=/\d+@N\d+/,m=/^http:\/\/(?:www\.)?flickr\.com\/(\w+)\/(?:([^\/]+)\/(?:(\w+)\/?(?:([^\/]+)\/?)?)?)?(?:\?(.*))?/,n={api_key:"af2780245ce7add695f16a91fb7d3afc",format:"json"},k={imageSize:"medium",thumbsize:"thumbnail",
...
link:(f+"photos/"+e.photoset.owner+"/sets/"+e.photoset.id+"/").replace(/\s/g,"_"),thumbnailSrc:p.isSingleLink?void 0:c(e.photoset.photo[0],i[t.thumbsize]),title:"None"});l&&l(g)},error:function(){if(options.onLoadError)options.onLoadError("Flickr plugin encountered an error while retrieving data")}})}var u=!0,q=p.url&&p.url.match(m),r,s={},y={method:"flickr.urls.lookupUser",onData:function(a){return{user_id:a.user.id,username:a.user.username._content}}};if(p.url&&!q)return!1;if(q){var v=q[1],w=q[2],
x=q[3],z=q[4];if(q=q[5])r=yox.utils.url.queryToJson(q),a.extend(s,r);if("search"==v){s.method="flickr.photos.search";s.text=r.q;r.w&&(r.w=r.w.replace("%40","@"),r.w.match(h)&&(s.user_id=r.w));if(!r||!r.sort)s.sort="relevance";u=!1}else x?(a.extend(s,o[x||"default"](p,z)),"galleries"===x&&z&&(u=!0,y={method:"flickr.urls.lookupGallery",onData:function(a){return{gallery_id:a.gallery.id,title:a.gallery.title}}})):s.method="flickr.people.getPublicPhotos",s.username=w,s.type=x}var t=jQuery.extend({},k,
...
yox.data.sources.html=function(){return{name:"html",match:function(a){return yox.utils.dom.isElement(a)||a instanceof jQuery||a.element&&yox.utils.dom.isElement(a.element)||a.element instanceof jQuery},load:function(a,c){var b=[];if(a.selector&&a.element)for(var d=a.element.querySelectorAll(a.selector),f=0,e=d.length;f<e;f++){var h=d[f];b.push({element:h,type:"html",title:h.title||h.getAttribute("data-title"),width:h.clientWidth,height:h.clientHeight,thumbnail:{src:h.getAttribute("data-thumbnail"),
className:a.thumbnailsClass||"yox-thumbnail"}});h.parentNode.removeChild(h)}c({items:b,source:a,sourceType:"html",createThumbnails:!0})}}}();
yox.data.sources.picasa=function(){function a(a,b){var d=a.match(e),l=$.extend({},k,b);d&&1<d.length&&(l.user=d[1],d[2]?(l.album=d[2],l.fields+=",entry(summary),gphoto:name"):l.fields+=",entry(title),entry(gphoto:numphotos),entry(gphoto:name),entry(link[@rel='alternate']),author,entry(summary)");l.imgmax=c(n,l.imgmax);l.thumbsize=c(l.cropThumbnails?m:n,l.thumbsize)+(l.cropThumbnails?"c":"u");return l}function c(a,b){for(var c=Math.min(b,Math.max(screen.width,screen.height)),e=a.length,d;e-- -1&&(d=
a[e])&&a[e-1]>=c;);return d}function b(a){var b=h;a.user&&"lh"!=a.user?(b+="user/"+a.user,a.album&&(b+="/album/"+a.album)):b+="all";return b}function d(a){var b=[];jQuery.each(a.feed.entry,function(a,c){var e="album"===c.category[0].term.match(/#(.*)$/)[1];if(e&&!c.gphoto$numphotos.$t)return!0;var d=c.media$group.media$content[0],f={thumbnail:{src:c.media$group.media$thumbnail[0].url},url:d.url,link:c.link[0].href,title:e?c.title.$t:c.summary.$t,type:"image"};e?(f.data={album:{name:c.title.$t,imageCount:c.gphoto$numphotos.$t,
description:c.summary.$t}},f.isLoaded=!0):$.extend(f,{width:d.width,height:d.height,ratio:d.height/d.width});b.push(f)});return b}var f=/^https?:\/\/picasaweb\.google\./,e=/https?:\/\/picasaweb\.google\.\w+\/([^\/#\?]+)\/?([^\/#\?]+)?(\?([^#]*))?/,h="http://picasaweb.google.com/data/feed/api/",m=[32,48,64,72,104,144,150,160],n=[94,110,128,200,220,288,320,400,512,576,640,720,800,912,1024,1152,1280,1440,1600].concat(m).sort(function(a,b){return a-b}),k={setThumbnail:!0,setSingleAlbumThumbnails:!0,setTitle:!0,
alt:"json",cropThumbnails:!1,thumbsize:64,imgmax:n[n.length-1],fields:"category(@term),entry(category(@term)),title,entry(summary),entry(media:group(media:thumbnail(@url))),entry(media:group(media:content(@url))),entry(media:group(media:content(@width))),entry(media:group(media:content(@height))),entry(link[@rel='alternate'](@href))"};return{name:"picasa",match:function(a){return a.url&&f.test(a.url)},load:function(c,e){var f=a(c.url,c);$.ajax({url:b(f),dataType:"jsonp",data:f,success:function(a){var b=
{source:c,sourceType:"picasa"};if(!a.feed.entry||0==a.feed.entry.length)b.items=[];else{var f=a.feed.category[0].term.match(/#(.*)$/)[1];"user"===f&&$.extend(b,{title:a.feed.title.$t,data:{kind:"user",author:{name:a.feed.author[0].name.$t,link:a.feed.author[0].uri.$t}}});b.createThumbnails=!0;b.items=d(a,f)}e&&e(b)},error:function(a,b){console.log("error: ",arguments)}})}}}();
...
d),!d.isSingleVideo&&(a=a.data.title))i.title=a;e(i)},error:function(){if(d.onLoadError)d.onLoadError("YouTube plugin encountered an error while retrieving data")}})}}}(jQuery);
(function(a){a.fn.yoxscroll=function(c){if(0!=this.length){var b=a(this),d=b.data("yoxscroll");if("string"===typeof c&&d&&d[c])return d[c].apply(d,Array.prototype.slice.call(arguments,1));"object"===typeof c||!c?b.data("yoxscroll",new yox.scroll(this,c)):a.error("Method "+c+" does not exist on yox.scroll.")}return this};yox.scroll=function(a,b){this.container=a;this.init(b)};yox.scroll.prototype=function(){var c,b,d;function f(b,c,d){a(b);var e=b.getElementsByTagName("img"),i=e.length,f=new Date;
if(i){var g=0,l=function(a){d&&d.call(this,a);if((a instanceof Date||"IMG"===a.target.nodeName)&&++g===i)b.removeEventListener("load",l,!0),c&&c(i)},h=function(a){d&&d.call(this,a);++g===i&&c&&c(i);a.srcElement.detachEvent("onload",h)};if(b.addEventListener)b.addEventListener("load",l,!0);else if(b.attachEvent)for(var p=i;p--;)e[p].attachEvent("onload",h);for(p=i;p--;)e[p].complete&&l(f)}else c&&c(0)}function e(){return/(Android)|(iPhone)|(iPod)/.test(navigator.userAgent)||4E5>screen.width*screen.height}
function h(b,c){var d=a(b).data("yoxscroll-"+c);if(d){var d=d.split("-"),e=this[d.shift()];e&&e.apply(this,d)}}function m(){g=v;u=parseInt(this.elements.$slider.css("left"),10)}function n(a,b,c){var d=(a.timeStamp||new Date)-x;if(!d)return!1;z=d;x=a.timeStamp||new Date;w=a.pageX-v;v=a.pageX;this.enableDrag&&(a=u+v-g,d=Math.abs(w)/w,a>=c&&0>=a?b.css("left",a):((!w||d!==r)&&m.call(y),a<c&&s!==c?b.css("left",a=c):0<a&&0!==s&&b.css("left",a=0)),q=!0,r=d,s=a)}function k(a,b,c){var d=this.elements.$slider;
s=c?parseInt(d.css("left"),10):s;var c=s+b*r,e=0<c?(b-c)/b:c<this.minPosition?(b-this.minPosition+c)/b:1;0!==e&&(c=s+e*b*r,a*=e,b=E.getCubicBezier(e),d.css({transition:"left "+a+"s cubic-bezier("+b+")",left:c}))}function o(a){y.elements.$window.off(c,D);currentDirection=0;a.data.view.elements.$window.off(b,o);if(a.data.view.enableDrag&&0!==w){var d=Math.min(Math.abs(w)/(7*z),0.86),e=d*t,d=Math.round(1E3*d*d*t);k.call(a.data.view,e,d);q=!1;y=null}return!1}function i(i){var f=this;i.on(d,function(d){var g=
e?window.event.touches[0]:d;d.preventDefault();v=g.pageX;x=g.timeStamp||new Date;m.call(f,d);f.enableDrag&&i.css({transition:"none",left:i.css("left")});w=0;q=!1;y=f;a(window).on(c,{$slider:i,minPosition:f.minPosition,view:f},D).on(b,{view:f},o)}).on(b,function(a){a.preventDefault();var b=v,b=b>g-4&&b<g+4;(f.enableDrag&&!q||b)&&f.triggerEvent("click",a)})}var p={centerContentsIfNotScrollable:!0,events:{buttonholdstart:function(a){h.call(this,a,"holdstart")},buttonholdend:function(){this.stopScroll()},
buttonclick:function(a){h.call(this,a,"click")}},"float":"left",isHorizontal:!0,scrollByTime:0.5,scrollToEasing:"ease-in-out",scrollToElementTime:0.2,scrollVelocity:500,toggleButtons:!0},l=a(window),g,u,q=!1,r=0,s,y,v,w=0,x,z,t=2.5,e=e();c=e?"touchmove":"mousemove";d=e?"touchstart":"mousedown";b=e?"touchend":"mouseup";var A,C,B={buttonDown:function(c){c.preventDefault();var d=this,i=c.data.view.options.pressedButtonClass;i&&a(d).addClass(i);A=setTimeout(function(){l.on(b,c.data,B.holdEnd);if(!e)l.on("mouseout",
...
c=[new a(0,0),new a(b[0],b[1]),new a(b[2],b[3]),new a(1,1)],d=b.join(", ");return{getCubicBezier:function(b){if(b)return d;for(var e=[c,[],[],[]],i=[c[0]],f=1;3>=f;f++)for(j=0;j<=3-f;j++){var g=new a(Math.abs(b-1)*e[f-1][j].x+b*e[f-1][j+1].x,Math.abs(b-1)*e[f-1][j].y+b*e[f-1][j+1].y);e[f][j]=g;j||i.push(g)}b=i[3];for(f=1;4>f;f++)g=i[f],g.x/=b.x,g.y/=b.y;return[i[1].x,i[1].y,i[2].x,i[2].y].join(", ")}}}(),D=e?function(a){n.call(a.data.view,window.event.touches[0],a.data.$slider,a.data.minPosition)}:
...
{},p,c);c.toggleButtons&&(c.events.changeStatus=function(a){this.options.elements.toggle(a.scrollEnabled)});for(var d in b){var e=c.events[d],f=b[d];e?e instanceof Array||(e=c.events[d]=[e]):e=c.events[d]=[];f instanceof Array?e=e.concat(f):"function"===typeof f&&e.push(f)}this.options=c;d=this.elements={$window:a(window),$container:a(this.container),$slider:a("<div>",{"class":"yoxscrollSlider",css:a.extend({position:"relative",top:0,left:0},c.isHorizontal?{height:"100%"}:{width:"100%"})})};a.browser.webkit&&
d.$slider[0].style.setProperty("-webkit-transform","translateZ(0)",null);b=d.$container;"static"===b.css("position")&&b.css("position","relative");b.children().appendTo(d.$slider);d.$slider.appendTo(d.$container);this.initEvents();this.update();this.initButtons();i.call(this,d.$slider);d.$slider.on("click",function(a){a.preventDefault()})},initButtons:function(){if(!this.options.elements)return!1;if(this.options.elements instanceof jQuery)this.options.elements.on(d,{view:this},B.buttonDown).on(b,
...
scrollTo:function(b,c){var c=c||{},d=this.elements.$slider,e=parseInt(d.css("left"),10),i=b instanceof jQuery,f=i?b:void 0,g=c.time;b instanceof HTMLElement&&(f=a(b),i=!0);if(i){i=f.position().left;f=f.width();if(c.centerElement)b=(this.containerSize-f)/2-i;else{var l=i+e;if(l+f>this.containerSize)b=this.containerSize-i-f;else if(0>l)b=-1*i;else return!1}g=g||this.options.scrollToElementTime}c.isRelative&&(b+=e);b=Math.min(Math.max(b,this.minPosition),0);void 0===g&&(g=Math.abs(b-e)/this.options.scrollVelocity);
0===b&&!1!==c.allowCenter&&this.options.centerContentsIfNotScrollable&&!this.enableDrag?this.elements.$slider.css({transition:"none",left:this.minPosition/2}):d.css("transition","left "+g+"s "+(c.easing||this.options.scrollToEasing)).css("left",b)},stopScroll:function(){var a=this.options.scrollVelocity/20/t;k.call(this,a/10,0,!0)},update:function(){this.elements.$container.children(":not(.yoxscrollSlider)").appendTo(this.elements.$slider);f(this.elements.$container[0],void 0,this.updateSize.bind(this))},
updateSize:function(){var a=this.calculateSliderSize();this.elements.$slider.width(a);this.containerSize=this.elements.$container.width();this.minPosition=this.containerSize-a;a=0>this.minPosition;a!==this.enableDrag&&(this.enableDrag=a,(!a&&!this.options.centerContentsIfNotScrollable||0<parseInt(a&&this.elements.$slider.css("left"),10))&&this.elements.$slider.css({transition:"none",left:0}),this.triggerEvent("changeStatus",{scrollEnabled:a}));this.options.centerContentsIfNotScrollable&&!a&&this.elements.$slider.css({transition:"none",
left:this.minPosition/2})}}}()})(jQuery);
...
f);this.addEventListener("beforeDestroy",function(){a.removeEventListener("loadSources",f)});a.addEventListener("clear",function(){e.clear();this.itemCount=0})},clear:function(){this.thumbnails&&this.thumbnails.remove();this.itemCount=0;this.currentSelectedThumbnail=null},createThumbnail:function(b){var d=a("<a>",{href:b.link||b.url,title:!1!==this.options.renderThumbnailsTitle?b.title:c,"class":this.options.thumbnailClass});d.append(a("<img>",{src:this.options.useFullImages?b.url:b.thumbnail.src,
alt:b.title}));return d[0]},createThumbnails:function(b){var c=this,f;this.thumbnails=this.thumbnails||a();if(!1!==b.createThumbnails){if(a.tmpl)f=a.tmpl(a.template(this.template),b.items,{options:this.options,getIndex:function(){return c.itemCount++}}),f.appendTo(this.container),this.thumbnails=f;else{f=document.createDocumentFragment();for(var e=0,h=b.items.length;e<h;e++,this.itemCount++){var m=b.items[e],n=this.createThumbnail(m);n.setAttribute("data-yoxthumbindex",this.itemCount);m.thumbnail.element=
n;m.thumbnail.generated=!0;var k=n.getElementsByTagName("img");k.length&&(m.thumbnail.image=k[0]);f.appendChild(n)}this.container.appendChild(f);this.thumbnails=this.thumbnails.add(a(this.container).children("."+this.options.thumbnailClass))}f=this.container.childNodes}else f=a("a:has(img)",this.container).attr("data-yoxthumbindex",function(){return c.itemCount++}),this.thumbnails=this.thumbnails.add(f),f=f.get();this.triggerEvent("create",{thumbnails:f,items:b.items})},defaults:{allowAppend:!0,renderThumbnailsTitle:!0,
selectedThumbnailClass:"selectedThumbnail",thumbnailClass:"yoxthumbnail"},destroy:function(){this.triggerEvent("beforeDestroy")},select:function(a){this.currentSelectedThumbnail&&this.currentSelectedThumbnail.removeClass(this.options.selectedThumbnailClass);this.thumbnails&&(this.currentSelectedThumbnail=this.thumbnails.eq(a).addClass(this.options.selectedThumbnailClass))},template:"<a class='${$item.options.thumbnailClass}' href='${link || url}'{{if $item.options.renderThumbnailsTitle}} title='title'{{/if}} data-yoxthumbIndex='${$item.getIndex()}'><img src='${thumbnail.src}' alt='${title}' /></a>"};
...
a.append(c):c=a[0],a.data(b,c),c!==a[0]&&(c.style.height=c.style.width="100%",c.style.display="none"));return c}function h(a){for(var b=[],c=this.items.length,d=0;d<a.length;d++){var e=a[d];this.items=this.items.concat(e.items);b=b.concat(e.items)}d=c;for(c=this.items.length;d<c;d++)this.items[d].id=d+1;this.triggerEvent("load",{items:b,sources:a});this.initialized||(this.initialized=!0,this.triggerEvent("init"))}function m(a){if(a!==this.currentItem)return!1;var b=o[a.type],c=b.checkLoading?this.transition.getCurrentPanel():
this.transition.getPanel(),d=c.data("itemType"),f=e.call(this,c,a.type);d!==a.type&&(d&&(d&&b.clear.call(this,f),c.data(d).style.display="none"),c.data("itemType",a.type));b.checkLoading&&!f.loading&&(c=this.transition.getPanel(!0),f=e.call(this,c,a.type));f.style.display="block";b.set.call(this,a,f)}var n={};c={40:"down",35:"end",13:"enter",36:"home",37:"left",39:"right",32:"space",38:"up",72:"h",27:"escape"};b=function(a){var b=a.data.view,d=b[b.options.keyPress[c[a.keyCode]]];return d?(a.preventDefault(),
d.call(b),!1):!0};var k={resizeMode:function(a){this.getPosition=yox.utils.dimensions.resize[a]},transition:function(a){this.transition.destroy.call(this);d.call(this,a);a=this.currentItem.id-1;this.currentItem=null;this.selectItem(a)}},o={html:{clear:function(a){a.innerHTML=""},create:function(){var a=document.createElement("div");a.style.overflow="hidden";return a},set:function(a,b){b.loading=!1;a.element?(b.innerHTML="",b.appendChild(a.element)):b.innerHTML=a.html;a.width||(a.width=this.containerDimensions.width);
a.height||(a.height=this.containerDimensions.height);a.ratio=a.height/a.width;this.transition.transition.call(this,{position:this.getPosition(a,this.containerDimensions,this.options),index:a.id-1});this.triggerEvent("select",a)}},image:function(){function b(a){this.loading=!1;a=a instanceof yox.view?a:a.data.view;if(a.currentItem.url!==this.src)return!1;var c=a.currentItem,d=a.getPosition(c,a.containerDimensions,a.options);a.transition.transition.call(a,{position:d,index:c.id-1});a.triggerEvent("select",
c)}return{checkLoading:!0,clear:function(a){a.src=""},create:function(){var c=document.createElement("img");c.src="";a(c).on("load",{view:this},b);return c},set:function(a,c){c.loading=!0;c.src!==a.url?(c.src="",c.src=a.url):b.call(c,this)}}}()};return{addDataSource:function(a){if(n[a.name])return!1;n[a.name]=a},addItems:function(a){if(!a)return!1;a instanceof Array||(a=[a]);h.call(this,{items:a})},addDataSources:function(a){function b(a){h.call(c,a)}var c=this,d=a.getData();d&&d.length&&h.call(c,
d);a.addEventListener("loadSources",b);this.addEventListener("beforeDestroy",function(){a.removeEventListener("loadSources",b)});a.addEventListener("clear",function(){c.removeItems()})},cacheCount:0,destroy:function(){this.triggerEvent("beforeDestroy");this.disableKeyboard();this.transition.destroy()},disableKeyboard:function(){a(document).off("keydown.modules",b)},enableKeyboard:function(){a(document).on("keydown.modules",{view:this},b)},first:function(){if(!this.currentItem)return!1;this.selectItem(0)},
items:[],init:function(){var b=this;this.options.margin=yox.utils.dimensions.distributeMeasures(this.options.margin);this.options.padding=yox.utils.dimensions.distributeMeasures(this.options.padding);var c=this.options.eventsHandler||new yox.eventsHandler;a.extend(this,c);for(var d in this.options.events)if(c=this.options.events[d],c instanceof Array)for(var e=0;e<c.length;e++)b.addEventListener(d,c[e]);else b.addEventListener(d,c);f(this);this.options.data&&this.addDataSources(this.options.data);
...
0:this.currentItem.id,void 0,a)},option:function(b,c){var d;void 0===c&&Object(b)===b?d=b:(d={},d[b]=c);for(var e in d){var f=this.options[e],h=d[e];if(f!==h){var m=k[e];m&&m.call(this,h,f)}}this.transition.update&&this.transition.update.call(this,d);a.extend(!0,this.options,d)},toggleSlideshow:function(){var a=this;this.isPlaying?(clearTimeout(this.playTimeoutId),this.isPlaying=!1,this.triggerEvent("slideshowStop")):(this.isPlaying=!0,this.playTimeoutId=setTimeout(function(){a.next.call(a,!0)},this.options.slideshowDelay),
...
this.toggleSlideshow():d&&!this.isPlaying&&(this.isPlaying=!0,this.triggerEvent("slideshowStart"));if(isNaN(b))b instanceof HTMLElement&&(b=a(b)),b instanceof jQuery&&(d=b.data("yoxviewIndex"),isNaN(d)&&(d=parseInt(b.attr("data-yoxviewIndex"),10)),b=this.items[d]);else{if(b>=this.items.length||0>b)throw Error("Invalid item index: "+b);b=this.items[b]}var d=this.currentItem,e=this;if(d&&b.id===d.id)return!1;this.triggerEvent("beforeSelect",{newItem:b,oldItem:d,data:c});this.currentItem=b;this.cache.withItem(b,
this,function(a){m.call(e,a)})},unload:function(){},update:function(a){this.options.transitionTime&&this.updateTransitionTimeoutId&&(clearTimeout(this.updateTransitionTimeoutId),this.updateTransitionTimeoutId=null);var b={width:this.$container.width(),height:this.$container.height()};if(a||!this.containerDimensions||b.width!==this.containerDimensions.width||b.height!==this.containerDimensions.height)this.containerDimensions=b,this.currentItem&&this.transition.transition.call(this,{position:this.getPosition(this.currentItem,
...
!0)},Number(this.options.slideshowDelay)+Number(this.options.transitionTime||0)))}},container:document.body||document.getElementsByTagName("body")[0],lightbox:!1,panelDimensions:{width:1600,height:1600},resizeMode:"fit",slideshowDelay:3E3,storeDataSources:!1},mode:{fill:{transition:"fade",enlarge:!0,margin:0,padding:0},fit:{transition:"morph"}},platform:{mobile:{cacheBuffer:2,margin:0,padding:0,showInfo:!0,transitionTime:0},desktop:{cacheBuffer:5,margin:20,padding:0,showInfo:!0,transitionTime:300}}}})(jQuery);
yox.view.cache=function(){function a(a,c){var d=!0;e++;c&&++a.cacheCount===a.items.length&&(delete a.cacheCount,a.isLoaded=!0,d=!1);d&&(d=e+o<a.options.cacheBuffer);d&&b(a)}function c(b){if(!this.width||!this.height)return!1;var b=m[n=b.data.cacheImageIndex],c=b.item,d=b.view;c.width=this.width;c.height=this.height;c.ratio=this.height/this.width;c.isLoaded=!0;c.id===p&&(d.triggerEvent("cacheEnd",c),p=null);d.triggerEvent("loadItem",c);b.onCache&&(b.onCache.call(d,c),b.onCache=null);o--;delete b.item;
a(d,!0)}function b(a){var b=a.items.length,c=f+a.direction;c===b?c=0:-1===c&&(c+=b);d(a,a.items[c],null,k)}function d(c,d,g){if(!(c instanceof yox.view))throw new TypeError("Invalid view for cacheItem.");if(!c)throw Error("View is required for cacheItem.");if(4>arguments.length||arguments[3]!==k)e=0;d=d||c.items[0];if("image"!==d.type)return g&&g.call(c,d),!0;for(var i=0;i<h;i++){var l=m[i];if(l.view&&l.view.id===c.id&&l.item&&l.item.id===d.id&&g)return l.onCache=g,!0}f=d.id-1;!d.isLoaded&&"image"===
...
left:this.options.margin.left,height:"100%",border:"none",overflow:"visible"}));c=[];for(b=0;2>b;b++){var e=$("<div>",{"class":"yoxviewImg"});e.css({backfaceVisibility:"hidden",background:"Black",position:"absolute",top:"50%",left:"50%",width:0,height:0,border:"solid 1px #666",transform:b?"rotateY(180deg)":"rotateY(0)",marginLeft:"-"+this.options.margin.left+"px"});e.attr("data-index",b);c.push(e.appendTo(a))}};this.destroy=function(){h.$container.css("perspective","");a.remove()};this.getCurrentPanel=
...
yox.theme.prototype={create:function(){throw Error("'create' method is not implemented for this theme.");},destroy:function(){throw Error("'destroy' method is not implemented for this theme.");},getThemeClass:function(a){return"yox-theme-"+this.name+(a?"-"+a:"")},init:function(a,c,b){function d(a,b,d){d.data=c;d.eventsHandler={addEventListener:function(a,b){f.addEventListener(a,b.bind(this))},triggerEvent:function(a,c){f.triggerEvent.call(this,a+"."+b,c,d.id)}};return new n(a,d)}if(!(c instanceof
...
yox.themes.classic=function(a,c){function b(){}function d(a){$(a).toggleClass("yox-theme-classic-button-on")}function f(){r&&(q=!q);q?(l.modules.view.option("resizeMode","fit"),g.gallery.style.cursor="none"):(g.gallery.style.height=y+"px",g.gallery.style.cursor="default");h();var a=$(window),b=q?a.on:a.off;b.call(a,"mousemove",n);r||b.call($(document),"keydown",m);s=!1;h();d(z.fullscreen)}function e(){s=!0;r?q?document.cancelFullScreen():(g.gallery.style.height="100%",g.gallery.requestFullScreen()):
(q=!q,g.gallery.style.position=q?"fixed":"relative",g.gallery.style.height=q?"100%":y,g.gallery.style.border=q?"none":"solid 1px Black",g.gallery.style.zIndex=q?"100":"1",f())}function h(){if(s)return!1;q||k();l.modules.view.update(!0)}function m(a){27===a.keyCode&&e()}function n(a){if(!v||a.pageX<v.x-3||a.pageX>v.x+3||a.pageY<v.y-3||a.pageY>v.y+3)clearTimeout(u),g.controlsPanel.style.opacity="1",g.gallery.style.cursor="default",u=setTimeout(function(){var b=g.controlsPanel.getClientRects()[0];a.pageY>=
b.top&&a.pageY<=b.bottom&&a.pageX>=b.left&&a.pageX<=b.right||(g.controlsPanel.style.opacity="0",g.gallery.style.cursor="none")},1E3);v={x:a.pageX,y:a.pageY}}function k(){g.gallery.style.height=g.container.clientHeight-(x?c.thumbnailsHeight:0)+"px"}function o(){h();l.triggerEvent("resize")}function i(a){var b=document.createElement("a");b.innerHTML=a.title;b.className=l.getThemeClass("button")+" "+l.getThemeClass("button-"+a.action);b.setAttribute("data-action",a.action);return b}function p(a){var b=
document.createElement("a"),c=l.getThemeClass("controlBtn");b.setAttribute("data-method",a);b.className=c+" "+c+"-"+a;b.innerHTML="<div></div>";return b}var l=this,g,u,q,r,s,y,v,w=c.showInfo,x=c.showThumbnails,z={},t=a.countItems(),A={fullscreen:e,info:function(a){w=!w;g.infoPanel.style.opacity=w?"1":"0";d(a)},slideshow:function(){l.modules.view.toggleSlideshow()},thumbnails:function(a){x=!x;g.gallery.style.height=g.gallery.clientHeight+c.thumbnailsHeight*(x?-1:1)+"px";l.modules.view.update();d(a)}};
this.name="classic";this.config={view:{enableKeyboard:!0,enlarge:!0,resizeMode:"fit",transition:yox.view.transitions.fade,transitionTime:300,margin:0,events:{cacheStart:function(){g.loader.style.display="inline"},cacheEnd:function(){g.loader.style.display="none"},"click.thumbnails":function(a){this.selectItem(a.index,"scroll")},"init.view":function(){this.selectItem(this.options.firstItem||0);g.infoPanel.style.opacity="1"},slideshowStart:function(){d(z.slideshow)},slideshowStop:function(){d(z.slideshow)}}},
thumbnails:{events:{beforeSelect:function(a){this.select(a.newItem.id-1);g.infoPosition.innerHTML=a.newItem.id},loadItem:function(a){$(this.thumbnails[a.id-1]).addClass("loaded")},"create.thumbnails":function(){this.select(0)}}},scroll:{events:{"create.thumbnails":function(){this.update()},"select.thumbnails":function(a){this.scrollTo(a,{centerElement:!0,time:0.5})},resize:function(){q||this.updateSize()},beforeSelect:function(a){var b=a.newItem.id-1;l.modules.thumbnails.thumbnails&&this.scrollTo(l.modules.thumbnails.thumbnails[b],
{centerElement:!a.data});g.infoText.innerHTML=a.newItem.title||""}},pressedButtonClass:"enabledThumbnailsButton"}};a.addEventListener("loadSources",function(){g.infoItemsCount.innerHTML=a.countItems();$(g.container).removeClass(l.getThemeClass("loading"))});a.addEventListener("loadSourcesStart",function(){$(g.container).addClass(l.getThemeClass("loading"))});!1!==c.enableFullScreen&&(document.cancelFullScreen=document.cancelFullScreen||document.mozCancelFullScreen||document.webkitCancelFullScreen||
b,HTMLElement.prototype.requestFullScreen=HTMLElement.prototype.requestFullScreen||HTMLElement.prototype.mozRequestFullScreen||HTMLElement.prototype.webkitRequestFullScreen||b,r=document.cancelFullScreen!==b);!1!==c.enableFullScreen&&r&&document.addEventListener(document.mozCancelFullScreen?"mozfullscreenchange":"webkitfullscreenchange",f,!1);this.create=function(b){console.log("DATA: ",a.isLoading);$(b).addClass(this.getThemeClass()+(a.isLoading?" "+this.getThemeClass("loading"):""));g={container:b,
gallery:document.createElement("div"),viewer:document.createElement("div"),thumbnails:document.createElement("div"),thumbnailsPanel:document.createElement("div"),loader:document.createElement("div"),description:document.createElement("p"),controlsPanel:document.createElement("div"),controls:[],infoPanel:document.createElement("div"),info:document.createElement("div"),infoText:document.createElement("div"),infoPosition:document.createElement("span"),infoItemsCount:document.createElement("span")};g.$thumbnails=
$(g.thumbnails);var e=this.getThemeClass("thumbnailsBtn");g.thumbnailsPanel.className=this.getThemeClass("thumbnailsPanel");g.thumbnailsPanel.style.height=c.thumbnailsHeight-1+"px";g.thumbnailsPanel.innerHTML='<a href="#" class="'+e+" "+e+'_left" data-yoxscroll-holdstart="scroll-left" data-yoxscroll-click="page-left"></a><a href="#" class="'+e+" "+e+'_right" data-yoxscroll-holdstart="scroll-right" data-yoxscroll-click="page-right"></a>';g.thumbnailsPanel.appendChild(g.thumbnails);this.config.scroll.elements=
$("a",g.thumbnailsPanel);b.appendChild(g.gallery);g.gallery.appendChild(g.viewer);g.gallery.appendChild(g.description);b.appendChild(g.thumbnailsPanel);g.gallery.appendChild(g.loader);g.viewer.className=this.getThemeClass("viewer")+" yoxview";g.gallery.className=this.getThemeClass("gallery");g.thumbnails.className=this.getThemeClass("thumbnails")+" yoxthumbnails yoxscroll";g.thumbnails.style.height=c.thumbnailsHeight+"px";g.loader.className=this.getThemeClass("loader")+" yoxloader";g.description.className=
this.getThemeClass("description");g.controlsPanel.className=this.getThemeClass("controls");for(var b=[{title:"Fullscreen",action:"fullscreen"},{title:"Slideshow",action:"slideshow"},{title:"Info",action:"info"},{title:"Thumbnails",action:"thumbnails"}],e=0,f;f=b[e];e++)g.controlsPanel.appendChild(z[f.action]=i(f));$(g.controlsPanel).on("click","a",function(a){a.preventDefault();A[this.getAttribute("data-action")](this)});g.gallery.appendChild(g.controlsPanel);c.showInfo?d(z.info):g.infoPanel.style.opacity=
"0";c.showThumbnails&&d(z.thumbnails);b=document.createElement("div");b.className=this.getThemeClass("info-position");b.appendChild(g.infoPosition);b.appendChild(document.createTextNode(" / "));g.infoItemsCount.innerHTML=t;g.infoPosition.innerHTML="0";b.appendChild(g.infoItemsCount);g.info.appendChild(b);g.infoText.className=this.getThemeClass("info-text");g.info.appendChild(g.infoText);g.infoPanel.appendChild(g.info);g.gallery.appendChild(g.infoPanel);g.infoPanel.className=this.getThemeClass("infoPanel");
g.info.className=this.getThemeClass("info");g.gallery.appendChild(p("prev"));g.gallery.appendChild(p("next"));y=g.gallery.clientHeight;k();$(g.gallery).on("mousemove",n).on("click","."+this.getThemeClass("controlBtn"),function(){l.modules.view[this.getAttribute("data-method")]()});$(window).on("resize",o)};this.destroy=function(){$(g.container).removeClass(this.getThemeClass());g.container.removeChild(g.gallery);g.container.removeChild(g.thumbnailsPanel);g=null;clearTimeout(u);$(window).off("resize",
o)}};yox.themes.classic.defaults={showInfo:!0,showThumbnails:!0,thumbnailsHeight:61};yox.themes.classic.prototype=new yox.theme;
